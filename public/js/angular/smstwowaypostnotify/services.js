angular.module('smstwowaypostnotify.services', [])
        .service('RestServices', function ($http, $q, constantPageSmsxemail,notificationService) {
          ...
          this.copyKey = function (idSmsxEmail) {
            ...
            var url = constantPageSmsxemail.UrlPeticion.copykey + idSmsxEmail;
          ...
          this.createSmstwowayPost = function (data){
            var defer = $q.defer();
            var promise = defer.promise;
            var url = constantPageSmsxemail.UrlPeticion.create;
          ...
          this.getSavedCredentials = function () {
            var defer = $q.defer();
            var promise = defer.promise;
            var url = constantPageSmsxemail.UrlPeticion.getSavedCredentials;
            $http.get(url).then(function (resolve) {
                defer.resolve(resolve);
            }).catch(function (reject) {
                defer.reject(reject);
