function rowZone(dz, listofblocks) {
  this.dz = dz;
  this.listofblocks = [];
...
;
rowZone.prototype.createRow = function (elemnt) {
...
rowZone.prototype.drawHtml = function () {
  var row = $('<div class="row-of-blocks">\n\
					...
					<div class="row-icons-options">\n\
						...
						<div class="clone-row tool"><span class="fa fa-clone icon-white"></span></div>\n\
					</div>\n\
				</div>');
...
rowZone.prototype.cloneRow = function () {
  var t = this;
  var arr = [];
  this.content.find(".clone-row").on('click', function (ev) {
    t.dz.createRow(t);
  });
