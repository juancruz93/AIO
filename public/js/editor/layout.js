...
var layouts = [
	...
	new Layout(3, 'layout-three-columns', 'Layout with 3 Columns', config.imagesUrl + "/2m.png", [{name: 'preheader', width: 'full-width', widthval: 600}, {name: 'header', width: 'full-width', widthval: 600}, {name: 'body', width: 'full-width', widthval: 600}, {name: 'column1', width: 'third-width', widthval: 200}, {name: 'column2', width: 'third-width', widthval: 200}, {name: 'column3', width: 'third-width', widthval: 200}, {name: 'footer', width: 'full-width', widthval: 600}]),
...
var footerLay = new Layout(6, 'layout-footer', 'Layout for Footer', "", [{name: 'footer', width: 'full-width', widthval: 600}]);
