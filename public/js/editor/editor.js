...
Editor.prototype.objectExists = function (objMail) {
  ...
  if (objMail === 'Footer') {
    ...
    $('#edit-area').css('background-color', '#fff');
    this.newDropZones();
...
$(function () {
  ...
  gallery.createPagination();
  gallery.validatePage();

  $("#fastforwardmediagallery").click(function () {
    gallery.fastForWardMediaGallery();
  });
  $("#fastbackwardmediagallery").click(function () {
    gallery.fastBackWardMediaGallery();
  });
  $("#forwardmediagallery").click(function () {
    gallery.forWardMediaGallery();
  });
  $("#backwardmediagallery").click(function () {
    gallery.backWardMediaGallery();
  });
