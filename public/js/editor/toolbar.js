...
Toolbar.prototype.setSliderSize = function () {

  var title = $("<div class='option-title-toolbar'>Borde</div>");
  var slider = $("<input type='text' id='sliderToolbar'>");
...
Toolbar.prototype.activateSlider = function () {

  var fullwidth = this.component.row.dz.widthval / this.component.row.listofblocks.length;
  var value = Math.floor(this.width / fullwidth * 100);
  var t = this;
  $('#sliderToolbar').slider({min: 10, max: 100, value: 10, step: 1})
