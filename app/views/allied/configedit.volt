...
{% block content %}    
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
      <div class="title">
        Edición de la configuración de la cuenta aliada<strong>{{ allied.name }}</strong>
      </div>            
      <hr class="basic-line" />            
    </div>
  </div>       
  ...
  <div class="row"  ng-app="aio" ng-controller="ctrlAllied" >
    {#  <div class="row"  ng-app="aio" ng-controller="ctrlAllied" ng-init="">#}
      ...
      <form action="{{url('allied/configedit/' ~ allied.idAllied)}}" method="post" class="form-horizontal">
        <div class="block block-info">          
            ...
            {% for item in allied.alxs  %}
              {% if(item.idServices == services.sms) %}
                <div class="form-group" ng-init="smsTotal = {{  masteraccount.Config.smsLimit }}; sms = {{  masteraccount.Config.smsLimit }};   
                  smsLimit = {{ config.smsLimit }}; sl =  {{ config.smsLimit }};">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
              ...
              {% if(item.idServices == services.email_marketing) %}
                <div class="form-group" ng-init="spaceTotal = {{  masteraccount.Config.fileSpace }};
                  ss = {{  masteraccount.Config.fileSpace }};  mailTotal = {{  masteraccount.Config.mailLimit }}; 
                  mail = {{  masteraccount.Config.mailLimit }}; contactTotal = {{  masteraccount.Config.contactLimit }}; 
                  contact = {{  masteraccount.Config.contactLimit }};  mailLimit = {{ config.mailLimit }}; 
                  ml = {{ config.mailLimit }}; contactLimit = {{ config.contactLimit }}; cl = {{ config.contactLimit }};
                  fileSpace = {{  config.fileSpace }}; fs = {{  config.fileSpace }} ">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    <label  class="col-sm-4 ">Almacenamiento :</label>
                    <span class="input hoshi input-default  col-sm-6">                                       
                      {{ConfigForm.render('fileSpace', {'class': 'undeline-input' ,  'ng-change': 'spaceEdit(fs)' , 'ng-model': 'fileSpace', 'required': 'required' })}}
                    </span>
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default  col-sm-6">                                       
                      {{ConfigForm.render('mailLimit', {'class': 'undeline-input' ,  'ng-model': 'mailLimit', 'ng-change': 'mailLEdit(ml)' , 'required': 'required' })}}
                    </span>
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default  col-sm-6">                                  
                      {{ConfigForm.render('contactLimit', {'class': 'undeline-input',  'ng-model': 'contactLimit' , 'ng-change': 'contactLEdit(cl)', 'required': 'required' })}}
                    </span>
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default  col-sm-8">       
                      <select class="undeline-input select2"  id="mta" nam="mta" required="required">
                        {% for mt in mta %}
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default  col-sm-8">       
                      <select class="undeline-input select2"  ng-model="adapterSelected"  id="idAdapter" required="required">
                        {% for a in adapter %}
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default  col-sm-8">       
                      <select class="undeline-input select2"  ng-model="mailclassSelected"  id="idMailClass" required="required">
                        {% for m in mailclass %}
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default  col-sm-8">       
                      <select class="undeline-input select2"  ng-model="urldomainSelected"  id="idUrldomain" required="required">
                        {% for u in urldomain %}
          ...
          <div class="footer" align="right">
            ...
            <a href="{{url('allied/show/' ~ allied.idAllied)}}" class="button  btn btn-xs-round   round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
