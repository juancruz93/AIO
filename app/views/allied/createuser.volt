...
{% block content %}    
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
      <div class="title">
        Creación de un nuevo Usuario en el aliado <strong>{{(allied.name)}}</strong>
      </div>            
      <hr class="basic-line" />            
    </div>
  </div>
  ...
  <div class="row" ng-app="aio" ng-controller="ctrlAllied" >
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 wrap">
      <form action="{{url('allied/createuser')}}/{{(allied.idAllied)}}" method="post" class="form-horizontal">
        <div class="block block-info">          
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-12">
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default col-sm-8">                                          
                      {{UserForm.render('pass1',  {'class': 'undeline-input ' })}}
                    </span>
                  </div>       
                </div> 
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default  col-sm-8">           
                      <select class="undeline-input select2" ng-change="selectCountryUser()" ng-model="countrySelectedUser" required="required" onchange="clearselect()" >
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default  col-sm-8">                 
                      <select class="undeline-input select2 clearselect" ng-change="selectStateUser()" ng-model="stateSelectedUser" required>
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    <label  class="col-sm-4 text-right clearselect">*Ciudad:</label>
                    <span class="input hoshi input-default  col-sm-8">       
                      <select class="undeline-input select2"  ng-model="citySelectedUser" id="citySelectedUser" name="citySelectedUser"  required>
          ...
          <div class="footer" align="right">
            ...
            <a href="{{url('allied/listuser')}}/{{(allied.idAllied)}}" class="button shining btn btn-xs-round shining shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
