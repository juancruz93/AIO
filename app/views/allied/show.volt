  ...
  <div ng-app="aio" >
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
        <div class="title">
          Configuracion de la cuenta aliada <strong>{{allied.name}}</strong>
        </div>            
        <hr class="basic-line" />
        <p class="row">
        <div class="col-lg-8">En esta tabla encontrarán la configuracion de la cuenta aliada.</div>
        <div class="col-lg-4 text-right">
          <a href="{{url('accounts/')}}" class="button shining btn btn-sm default-inverted ">Regresar</a>
          {#        <a href="{{url('masteraccount/aliaslist/'~ allied.idMasteraccount)}}" class="button shining btn btn-sm default-inverted ">Regresar a lista de cuentas aliadas</a>#}
        </div>
        </p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
        <span class="text-2em">Nombre del plan: <b>{{ allied.PaymentPlan.name }}</b></span>
        <ul class="padding-left-20px">
          <li>Espacio en disco: <b>{{ space }} MB / {{ allied.PaymentPlan.diskSpace }} MB</b></li>
                        ...
                        <table class="table table-bordered sticky-enabled ">
                          ...
                          <div class="" align="right">
                            {% if(user.Role.idRole == 3) %}
                              <a href="{{url('masteraccount/aliaslist/'~ allied.idMasteraccount)}}" class="button btn round-button info-inverted" data-toggle="tooltip" data-placement="top" title="Regresar">
                                Regresar
                              </a>
                            {% endif %}
