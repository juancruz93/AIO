...
{% block content %}
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
      <div class="title">
        Usuarios del aliado <b>{{allied.name}}</b>
      </div>            
      <hr class="basic-line" />
      <p>
  ...
  {% if page.items|length != 0 %}
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap text-right">            
        <a href="{{url('allied/createuser/'~idAllied)}}" class="button shining btn btn-sm success-inverted">Crear un nuevo Usuario</a>
        {{ partial('partials/pagination_static_partial', ['pagination_url': 'allied/listuser/' ~ idAllied])}}
      </div>
    </div>
        ...
        <table class="table table-bordered">                
          ...
          <tbody>
            ...
            <td class="user-actions text-right">
                <button id="delete" onClick="openModal();" class="button shining btn btn-xs-round   round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Borrar este Usuario" data-id="{{url('allied/deleteuser')}}/{{item.idUser}}/{{allied.idAllied}}">
              ...
              <a href="{{url('allied/passedituser')}}/{{item.idUser}}/{{idAllied}}" class="button  btn btn-xs-round round-button primary-inverted" data-toggle="tooltip" data-placement="top" title="Editar contraseña del Usuario">
                <span class="glyphicon glyphicon-lock"></span>
              </a>
              <a href="{{url('allied/edituser')}}/{{item.idUser}}/{{idAllied}}" class="button  btn btn-xs-round  round-button info-inverted" data-toggle="tooltip" data-placement="top" title="Editar este Usuario">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
        <div class="block block-success">
          <div class="body success-no-hover text-center">
            <h2>
              No existen usuarios creados actualmente, si desea crear uno haga <a href="{{url('allied/createuser/'~idAllied)}}">clic aquí</a>.
            </h2>    
          </div>
        </div>
      </div>
