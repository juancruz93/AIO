...
{% block content %}
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
            <div class="title">
                Edición de un contacto administrativo
            </div>            
            <hr class="basic-line" />            
        </div>
    </div>    
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap">
            <form action="{{url('admincontact/edit')}}/{{Admincontact.idAdmincontact}}" method="POST" class="form-horizontal">
                <div class="block block-info">
                    ...
                    <div class="footer text-right">
                        ...
                        <a href="{{url('admincontact/index')}}/{{(Admincontact.idAllied)}}/{{ Admincontact.Allied.idMasteraccount }}" class="button shining btn btn-xs-round shining shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
