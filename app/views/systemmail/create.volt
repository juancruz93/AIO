    ...
    function sendData() {
      try {
        ...
        $.ajax({
          ...
          error: function (msg) {
            slideOnTop(msg.responseText, 3500, 'glyphicon glyphicon-remove', 'danger');
          },
          success: function () {
...
{% block content %}
          ...
          <div class="body">
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-9 col-md-9">
                  <input type="text" id="name" name="name" class="undeline-input" required autofocus>                                    
                </span>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-9 col-md-9">
                  <textarea class="undeline-input" rows="2" id="description" name="description" required="required"></textarea>
                </span>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-9 col-md-9">
                  <input type="text" id="category" name="category" class="undeline-input" required="required">               
                </span>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-9 col-md-9">
                  <input type="text" id="subject" name="subject" class="undeline-input" maxlength="80" required="required">                 
                </span>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-9 col-md-9">
                  <input type="text" id="fromName" name="fromName" class="undeline-input" required="required">             
                </span>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-9 col-md-9">
                  <input type="email" id="fromEmail" name="fromEmail" class="undeline-input" required="required">                       
                </span>
              </div>
            </div>
      ...
      <div class="form-horizontal">
        <div class="block block-info" style="border-top-color: transparent;border-top-left-radius: 0;border-top-right-radius: 0;">          
          ...
          <div class="footer" align="right">
            <button onClick="sendData();" class="button  btn btn-xs-round  round-button success-inverted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Guardar">
              <span class="glyphicon glyphicon-ok"></span>
            </button>
            <button onClick="htmlPreview();" class="button  btn btn-xs-round  round-button info-inverted" data-toggle="modal" data-target="#preview-modal">
              <span class="glyphicon glyphicon-eye-open"></span>
            </button>
            <a href="{{url('systemmail')}}" class="button  btn btn-xs-round   round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cancelar">
  ...
  <div class="modal fade bs-example-modal-lg" id="preview-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
