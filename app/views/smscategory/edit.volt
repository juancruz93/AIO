...
{% block content %}
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
      <div class="title">
        Edición de una categoría de SMS
      </div>            
      <hr class="basic-line" />            
    </div>
  </div>
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap">
      <form action="{{url('smscategory/edit')}}/{{smscategory.idSmsCategory}}" method="POST">
        <div class="block block-info">
          ...
          <div class="footer text-right">
            ...
            <a href="{{url('smscategory#/')}}" class="button shining btn btn-xs-round shining shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
