...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
    <div class="title">
      Editar campaña automática {{"{{campaign.nameCampaign}}"}}
    </div>            
    <hr class="basic-line" />
  </div>
</div>
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap ">
    ...
    <div class="space"></div>
    <div class="alert alert-danger" ng-show="errorCampaign">
      <strong>Ocurrio un error validando la configuración de la campaña:</strong> <p>{{'{{msgErrorCampaign}}'}}</p>
    </div>
    <div class="pull-right">
      <button class="btn button danger-inverted"  ng-click="toReturn()">Cancelar</button>   
     {# <button class="btn button primary-inverted" ng-click="opeModalUpdateCampaign()">Informacion de campaña</button>   #}
      <button class="btn button primary-inverted" ng-click="updateAutomaticCampaign(1)">Guardar y seguir editando</button>  
      <button class="btn button success-inverted" ng-click="opeModalUpdateCampaign()">Guardar y finalizar</button>  
    </div>
  </div>
</div>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 block-basic none-padding" >
  ...
  <div class="col-xs-12 col-sm-11 col-md-11 col-lg-11 none-padding-left " mouse-capture
...
<div id="updateStatusCampaign" class="dialog">
  <div class="dialog__overlay"></div>
  <div class="dialog__content">
    <div class="morph-shape">
      <svg xmlns="https://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 560 280" preserveAspectRatio="none">
    ...
    <div class="dialog-inner">
      <h2>¿Esta seguro?</h2>
      <div>
        para poder editar la campaña se debe de cambiar el estado ¿esta seguro?
      </div>
      <br>
      <div>
        <a ng-click="closeModalStatus();" class="button shining btn btn-md danger-inverted" data-dialog-close>Cancelar</a>
        <a ng-click="updateStatusCampaign()" id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar</a>
      </div>
    </div>
  </div>
</div>
<div id="updateAutomaticCampaign" class="dialog" >
  <div class="dialog__overlay"></div>
  <div class="dialog__content">
    <div class="morph-shape">
      <svg xmlns="https://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 560 280" preserveAspectRatio="none">
    ...
    <div class="dialog-inner">
      <div class="form-group row">
        <label for="name" class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-top: 10px;">*Nombre</label>
      ...
      <div class="form-group row">
        <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-top: 10px;">*Fecha Inicio</label>
        <div id='datetimepickerStart' class="col-xs-12 col-sm-10 col-md-10 col-lg-10 date">
          <span class="input-append date add-on input-group none-padding">
            <input id="datestartCampaign" data-format="yyyy-MM-dd hh:mm " type="text" class="undeline-input">
      ...
      <div class="form-group row">
        <label for="Category" class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-top: 10px;">*GMT</label>
        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 text-left text-left">
      ...
      <div class="form-group row">
        <p ng-show="showTextGmtStart" ><strong>Fecha de Inicio:</strong>{{"{{dateGmtStart}}"}}</p>

      </div>    
      <div class="form-group row">
        <label for="Category" class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-top: 10px;">*Categoría</label>
        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 text-left text-left">
      ...
      <div class="form-group row">
        <label for="Description" class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-top: 10px;">Descripcion</label>
        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
          <textarea id="Description" type="text" ng-model="formCampaign.descriptionCampaign" placeholder="Descripcion"  class="undeline-input" minlength="2" maxlength="200"></textarea>
      ...
      {#<div class="form-group row">
        <label for="Description" class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="padding-top: 10px;">Descripcion</label>
        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
          <md-switch ng-model="formCampaign.status" class="md-warn" md-no-ink aria-label="Switch No Ink"></md-switch>
        </div>
      </div>#}
      <br>
      <div>
        <a onClick="closeModalForm();" class="button shining btn btn-md danger-inverted" data-dialog-close>Cancelar</a>
        <a ng-click="uptCampaign()" id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar</a>
      </div>
    </div>
  </div>
</div>    
