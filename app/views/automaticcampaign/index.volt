...
{% block header %}
  ...
  {{ stylesheet_link('library/select2/css/selectize.default.min.css') }}    
...
{% block js %}
  ...
  {{ javascript_include('library/angularjs/1.5.0/angular-animate.min.js') }}
  {{ javascript_include('library/angularjs/1.5.0/angular-aria.min.js') }}
  {{ javascript_include('library/angular_material/1.0.7/angular-material.min.js') }}
  {{ javascript_include('library/angular-strap/2.1.5/angular-strap.min.js') }}
  {{ javascript_include('library/angular-strap/2.1.5/angular-strap.tpl.min.js') }}      
  ...
  {{ javascript_include('js/angular/automaticcampaign/dist/automaticcampaign.f5a989e4529cd933c858.min.js') }}
  ...
  {{ javascript_include('library/select2/js/es.js') }}
