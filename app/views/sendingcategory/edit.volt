...
{% block content %}
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
            <div class="title">
                Edición de la categoria <strong>{{sendingcat.name}}</strong>
            </div>            
            <hr class="basic-line" />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap"> 
            <form action="{{url('sendingcategory/edit')}}/{{sendingcat.idSendingcategory}}" method="post" class="form-horizontal">
