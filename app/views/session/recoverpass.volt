...
<div class="container-fluid">
  <h1 class="bold">Recuperar contraseña</h1>          
  <hr class="basic-line" /> 
  <div class="row">
    <div class="wrap">
      <form  method="post" class="form-horizontal" ng-submit="functions.validateRoles()">

        <div class="col-md-10 col-md-offset-1">
          <div class="form-group">
            <input class="undeline-input form-control input-lg" ng-disabled="misc.verified" type="email" autofocus="autofocus" placeholder="Dirección de corro electrónico" required="required" maxlength="100" data-ng-model="data.email"/>
          </div>
        </div>
        <div class="col-md-10 col-md-offset-1">
          <div class="form-group">
            <ui-select data-ng-model="data.rol" ng-show="data.roles.length >0" theme="selectize" style="text-align: left; width: 100%" title="Seleccione un rol">
              <ui-select-match placeholder="Debe seleccionar un rol">{{"{{$select.selected.name}}"}}</ui-select-match>
              <ui-select-choices repeat="item.idRole as item in data.roles | filter: $select.search">
        ...
        <div class="col-md-offset-3 col-md-8">
          <div class="login-button">
            <div class="login-button">
              <button type="submit" ng- class="button shining shining-round btn btn-sm-round success-inverted round-button">
            ...
            <div class="login-button">
              <a ng-click="functions.refress()" type="button" class="button shining shining-round btn btn-sm-round warning-inverted round-button">
            ...
            <div class="login-button">
              <a href="{{url('session')}}" type="button" class="button shining shining-round btn btn-sm-round danger-inverted round-button">
        ...
        <div class="col-md-10 col-md-offset-1">      
          <div class="form-group">
            <br>
            <p class="justify">  
              Para recuperar la contraseña escribe la dirección de correo electrónico con que fuiste registrado
              en la plataforma y en unos minutos recibirás un correo con las instrucciones para completar
              el proceso.
            </p>
          </div>      
        </div>     
