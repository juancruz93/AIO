...
{% block content %}    
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 wrap">
      <form action="{{url('account/passedit')}}/{{(userE.idUser)}}" method="post" class="form-horizontal">
        <div class="block block-info">
          <div class="body">
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-8">      
                  <input class="input-field input-hoshi undeline-input" type="password" min="8" autofocus name="pass1" required=""/>
                </span>
              </div>       
            </div>
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-8">                                        
                  <input class="  undeline-input" type="password" min="8" name="pass2" required="" />
                </span>
              </div>       
            </div>
          </div>
          <div class="footer" align="right">                        
            ...
            <a href="{{url('account/userlist')}}/{{(userE.UserType.idAccount)}}" class="button shining btn btn-xs-round shining shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
