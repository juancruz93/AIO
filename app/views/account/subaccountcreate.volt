...
{% block content %}    
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap">
            <form action="{{url('account/subaccountcreate')}}/{{(account.idAccount)}}" method="post" class="form-horizontal">
                <div class="block block-info">          
                    ...
                    <div class="footer" align="right">                        
                        <a href="{{url('account/subaccountlist')}}/{{(account.idAccount)}}" class="button shining btn btn-xs-round shining shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
