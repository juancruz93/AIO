...
<div class="row">
  <form novalidate name="contactlistForm" class="form-horizontal" role="form" ng-submit="addTheme()" enctype="multipart/form-data" >
      ...
      <div class="form-group">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
          ...
          <span class="input hoshi input-default  col-sm-11">
            <input type="text" maxlength="50" class="undeline-input" ng-model="name"  id="name" name="name" required>
          </span>
        </div>
      </div>
      <div class="form-group">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
          ...
          <span class="input hoshi input-default  col-sm-11">
            <textarea maxlength="200" class="undeline-input" ng-model="description" id="description" name="description"></textarea>
          </span>
        </div>
      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          ...
                          <span class="input hoshi input-default col-sm-9">
                            <input type="text" ng-model="title" class="form-control"   id="title" name="title" maxlength="60" >
                          </span>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          ...
                          <span class="input hoshi input-default col-sm-9">
                            <input colorpicker ng-model="mainColor" type="text" class='form-control' style="background-color:{{"{{mainColor}}"}}; color:{{"{{getContrastYIQ(mainColor)}}"}} ">
                          </span>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          ...
                          <span class="input hoshi input-default col-sm-9">
                            <input colorpicker ng-model="linkColor" type="text" class='form-control' style="background-color:{{"{{linkColor}}"}};color:{{"{{getContrastYIQ(linkColor)}}"}}">
                          </span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          <label class="col-sm-3 text-right">
                          ...
                          <span class="input hoshi input-default col-sm-9">
                            <input colorpicker ng-model="linkHoverColor" type="text" class='form-control' style="background-color:{{"{{linkHoverColor}}"}};color:{{"{{getContrastYIQ(linkHoverColor)}}"}}">
                          </span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          <label class="col-sm-3 text-right">
                          ...
                          <span  class="input hoshi input-default col-sm-9">
                            <input type="text" ng-model="mainTitle" class="form-control"   id="logo" name="logo" maxlength="60" >
                          </span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          <label class="col-sm-3 text-right">
                          ...
                          <span  class="input hoshi input-default col-sm-9" style="text-align: center;">
                            ...
                            <input style="margin: 0 auto" type="file" id="logo" name="logo" accept="image/jpeg,image/jpg,image/png,image/gif" required="required"  onchange='angular.element(this).scope().viewImg(this);
                                angular.element(this).scope().pushFiles(this, "logo");' >
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="body " >
                      <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          ...
                          <span class="input hoshi input-default col-sm-9">
                            <input colorpicker ng-model="headerColor" type="text" class='form-control' style="background-color:{{"{{headerColor}}"}};color:{{"{{getContrastYIQ(headerColor)}}"}}">
                          </span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          <label class="col-sm-3 text-right">
                          ...
                          <span class="input hoshi input-default col-sm-9">
                            <input colorpicker ng-model="headerTextColor" type="text" class='form-control' style="background-color:{{"{{headerTextColor}}"}};color:{{"{{getContrastYIQ(headerTextColor)}}"}}">
                          </span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          <label class="col-sm-3 text-right">
                          ...
                          <span class="input hoshi input-default col-sm-9">
                            <input colorpicker ng-model="userBoxColor" type="text" class='form-control' style="background-color:{{"{{userBoxColor}}"}};color:{{"{{getContrastYIQ(userBoxColor)}}"}}">
                          </span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          <label class="col-sm-3 text-right">
                            ...
                            *Color del cuadro de usuario cuando pasa por encima</label>
                          <span class="input hoshi input-default col-sm-9">
                            <input colorpicker ng-model="userBoxHoverColor" type="text" class='form-control' style="background-color:{{"{{userBoxHoverColor}}"}};color:{{"{{getContrastYIQ(userBoxHoverColor)}}"}}">
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="body " >
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          ...
                          <span class="input hoshi input-default col-sm-9">
                            <input colorpicker ng-model="footerColor" type="text" class='form-control' style="background-color:{{"{{footerColor}}"}};color:{{"{{getContrastYIQ(footerColor)}}"}}">
                          </span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                          <label class="col-sm-3 text-right">
                          ...
                          <span class="input hoshi input-default col-sm-9">
                            <input colorpicker ng-model="footerIconColor" type="text" class='form-control' style="background-color:{{"{{footerIconColor}}"}};color:{{"{{getContrastYIQ(footerIconColor)}}"}}">
                          </span>
                        </div>
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                            ...
                            <span ng-show="showSocial">
                              <div class='col-lg-3' style='float: right; margin-top: 1em; margin-bottom: 1em;'>
                                ...
                                <select ng-change="alterSocialBlockPosition()" ng-model="socialBlockPosition" style="width: 100%;padding: 3%;" id="socialBlockPosition">
                              ...
                              <table class="table table-bordered">
                                ...
                                <tbody id="social_networks">
                                  <tr ng-repeat="key in socials">
                                    {# {{"{{key}}"}}#}
                                    <td style='width:20%;'>
                                      <select ng-change="getInfoSocial($index,key.idSocial); orderSocial(); isEmptyPosition()" ng-model="key.idSocial" style="width: 100%;padding: 5%;" id="nameSocial{{"{{$index}}"}}">
                                        <option ng-repeat="social in socialnetworks[0].items track by $index" value="{{"{{social.idSocialNetwork}}"}}">{{"{{social.name}}"}}</option>
                                      </select>
                                    ...
                                    <td>
                                      <input type="text" maxlength="200" ng-change="orderSocial(); isEmptyPosition()" placeholder="https://www.miredsocial.com" class="undeline-input" ng-model="key.urlSocial"  id="urlSocial{{"{{$index}}"}}" name="urlSocial">
                                    </td>
                                    <td>
                                      <input type="text" maxlength="80" class="undeline-input" ng-change="orderSocial(); isEmptyPosition()" ng-model="key.titleSocial"  id="titleSocial{{"{{$index}}"}}" name="titleSocial">
                                    </td>
                                    <td>
                                      <input type="number"  ng-change="validateSocialPosition($index); orderSocial(); isEmptyPosition(); isOrderedPosition()" class="undeline-input" ng-model="key.positionSocial"  id="positionSocial{{"{{$index}}"}}" name="titleSocial" min='1' max='{{"{{ socialnetworks[0].items.length}}"}}'>
                                    </td>
                                    <td style='width:6%;'>

                                      <a href="" ng-click='deleteOne($index)' class="button shining btn btn-xs-round shining-round round-button danger-inverted">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                            ...
                            <span ng-show="showInfo">
                              ...
                              <div class='col-lg-3' style='float: right; margin-top: 1em; margin-bottom: 1em;'>
                                ...
                                <select ng-change="alterInfoBlockPosition()" ng-model="infoBlockPosition" style="width: 100%;padding: 3%;" id="infoBlockPosition">
                                  <option value="right">Derecha</option>
                                  <option value="left">Izquierda</option>
                                </select>
                              </div>
                              ...
                              <table class="table table-bordered">
                                ...
                                <tbody id="additional_info">
                                  <tr ng-repeat="key in infos">
                                    <td >
                                      <input type="text" maxlength="50" class="undeline-input" ng-model="key.textInfo"  id="textInfo{{"{{$index}}"}}" name="textInfo">
                                    </td>
                                    {#  <td>
                                    ...
                                    <td>
                                      ...
                                      <a href="" ng-click='deleteOneInfo($index)' class="button shining btn btn-xs-round shining-round round-button danger-inverted">
                                        <span class="glyphicon glyphicon-remove" aria-hidden="true">
                                          <md-tooltip md-direction="buttom">
