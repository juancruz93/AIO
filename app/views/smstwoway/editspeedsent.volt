    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 wrap">
      <div class="block block-info">          
          ...
          <div class="row">
              ...
              <div class="form-group" >
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                  ...
                  <span class="input-append date  col-sm-8 col-md-8 input-group datetimepicker"  style="padding-left: 15px; padding-right: 15px;">
                    <input type='text' id="dtpicker"  class="undeline-input" ng-model="data.originalDate"/>
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap"> 
                ...
                <span class="input hoshi input-default col-sm-8 col-md-8">
                  <textarea class="form-control" rows="2" id="destinatarios" ng-model="data.receiver"></textarea>
            ...
            <div ng-show="data.optionsAvanced" class="advancedoptions-container">
              ...
              <div class="form-group" id="email-addresses" ng-show="data.sendNotification" >
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                  ...
                  <span class="input hoshi input-default col-sm-8 col-md-8">
                    <textarea class="form-control" rows="2" id="destinatarios" ng-model="data.emailNotification"></textarea>
                  </span>
                </div>
              </div>
        ...
        <div class="footer" align="right">   
          ...
          <a href="{{url('smstwoway/index' )}}" class="button shining btn btn-xs-round shining shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
  ...
  <div class="dialog__content">
    ...
    <div class="dialog-inner">
      ...
      <div>                    
        ...
        <a ng-click="restServicesFunction.editLoteTwoway();{#addDisabled('btn-ok')#}"  id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar</a>
      </div>
    </div>
  </div>
</div>
