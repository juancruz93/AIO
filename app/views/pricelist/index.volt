...
{% block js %}
  ...
  {#{{ javascript_include('js/angular/pricelist/app.js') }}
  {{ javascript_include('js/angular/pricelist/controller.js') }}
  {{ javascript_include('js/angular/pricelist/services.js') }}#}
  
  {{ javascript_include('js/angular/pricelist/app.min.js') }}
  {{ javascript_include('js/angular/pricelist/controller.min.js') }}
  {{ javascript_include('js/angular/pricelist/services.min.js') }}
  {#
