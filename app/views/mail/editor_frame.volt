{% block header %}
  ...
  <script type="text/javascript">
    ...
    var totalAssetsMediaGallery = {{total}};
    var totalPageAssetsMediaGallery = {{total_pages}};
            ...
            <div class="tab-content imagesbody">
              ...
              <div id="uploadimage" class="tab-pane well">
                ...
                <form action="{{url('asset/upload')}}" class="dropzone" id="my-dropzone">
                  ...
                  <br>
                  <h4 class="text-center"><i>El Ancho de la imagen debe ser máximo de 600px</i></h4>
                </form>
              </div>
            </div>
          </div>
        ...
        <div id="clipsmodal" style="display: none" >
          <section>
            <ul class="redactor_clips_box">
              ...
              <li>
                <a href="#" class="redactor_clip_link">Link de encuesta</a>
                <div class="redactor_clip" style="display: none;">
                  <a href="%%SURVEY%%">Enlace de encuesta</a>
                </div>
              </li>
              {%if cfs is defined %}
                {%for cf in cfs%}
              ...
              <li>
                <a href="#" class="redactor_clip_link">Enlace de Suscriptores</a>
                <div class="redactor_clip" style="display: none;">
                  <a href="%%DOBLEOPTIN%%">Para suscriptores haga clic aqui</a>
                </div>
              </li>
              <li>
                <a href="#" class="redactor_clip_link">Enlace de Landing Page</a>
                <div class="redactor_clip" style="display: none;">
                  <a href="%%LANDINGPAGE%%">haga clic aqui para ir a la Landing Page</a>
                </div>
              </li>
            </ul>
          </section>
