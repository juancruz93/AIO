<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
    ...
    <p class="text-justify">
      Formulario para editar un plan de pago
    </p>
  </div>
</div>
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 wrap">
    <form data-ng-submit="editPaymentPlan()">
      <div class="block block-info">
        <div class="body row">
          <div class="col-md-12">
            <div class="body form-horizontal">
              <div class="form-group">
                <label for="idCountry" class="col-sm-3 control-label">{{form.label("idCountry")}}</label>
                <div class="col-sm-9">
                  <select class="chosen form-control" data-ng-model="data.idCountry" style="width: 100%" required="true" data-ng-change="loadTax()">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select class="chosen form-control" data-ng-model="data.type" style="width: 100%" required="true">
                    <option ng-repeat="x in listypes" value="{{"{{x.value}}"}}" data-ng-selected="x.value == data.type">{{"{{x.name}}"}}</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <ui-select multiple data-ng-model="tax.idTax" theme="bootstrap" sortable="false" close-on-select="true">
                    <ui-select-match >{{"{{$item.name}}"}}</ui-select-match>
                    <ui-select-choices repeat="key.idTax as key in listtax | propsFilter: {name: $select.search}">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <ui-select multiple data-ng-model="service.idServices" theme="bootstrap" sortable="false" close-on-select="true" data-ng-change="changeService()" required="">
                    <ui-select-match >{{"{{$item.name}}"}}</ui-select-match>
                    <ui-select-choices repeat="key.idServices as key in listServices | propsFilter: {name: $select.search}">
                      <div ng-bind-html="key.name | highlight: $select.search"></div>
                    </ui-select-choices>
                  </ui-select>
                </div>
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" data-ng-class="tabsms == true ? 'in active':''" id="sms">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <ui-select data-ng-model="sms.idPlanType" theme="select2" style="text-align: left; width: 100%;z-index: 2 !important;" title="Seleccione el tipo de plan">
                            <ui-select-match placeholder="Debe seleccione una lista de precios">{{"{{$select.selected.name}}"}}</ui-select-match>
                            <ui-select-choices repeat="item.idPlanType as item in plantypes | filter: $select.search">
                              <div ng-bind-html="item.name | highlight: $select.search" style="text-align: left"></div>
                            </ui-select-choices>
                          </ui-select>
                        </div>
                      ...
                      <div class="form-group">
                        <label for="pricelist" class="col-sm-3 control-label">*Listas de precios</label>
                        <div class="col-sm-9">
                          <ui-select data-ng-model="sms.idPriceList" theme="select2" style="text-align: left; width: 100%;z-index: 1 !important;" title="Seleccione una lista de precios">
                            <ui-select-match placeholder="Debe seleccione una lista de precios">{{"{{$select.selected.name}}"}}</ui-select-match>
                            <ui-select-choices repeat="item.idPriceList as item in listpricelistsms | filter: $select.search" refresh="search(1,$select.search)">
                              <div ng-bind-html="item.name | highlight: $select.search" style="text-align: left"></div>
                            </ui-select-choices>
                      ...
                      <div class="form-group">
                        <label for="adapter" class="col-sm-3 control-label">*Adaptador</label>
                        <div class="col-sm-9">
                          <ui-select multiple data-ng-model="sms.idAdapter" theme="bootstrap" close-on-select="true">
                            <ui-select-match >{{"{{$item.name}}"}}</ui-select-match>
                            <ui-select-choices repeat="key.idAdapter as key in listadapter | propsFilter: {name: $select.search}">
                              <div ng-bind-html="key.name | highlight: $select.search"></div>
                            </ui-select-choices>
                    ...
                    <div role="tabpanel" class="tab-pane fade" data-ng-class="tabemail == true ? tabsms == true  ? '':'in active':''" id="email_marketing">
                      ...
                      <div class="form-group">
                        <label for="plantype" class="col-sm-3 control-label">*Tipo de plan</label>
                        <div class="col-sm-9">
                          <ui-select data-ng-model="email.idPlanType" theme="select2" style="text-align: left; width: 100%;z-index: 3 !important;" title="Seleccione el tipo de plan">
                            <ui-select-match placeholder="Debe seleccione una lista de precios">{{"{{$select.selected.name}}"}}</ui-select-match>
                            <ui-select-choices repeat="item.idPlanType as item in plantypes | filter: $select.search">
                              <div ng-bind-html="item.name | highlight: $select.search" style="text-align: left"></div>
                            </ui-select-choices>
                      ...
                      <div class="form-group">
                        <label for="mta" class="col-sm-3 control-label">*Mta</label>
                        <div class="col-sm-9">
                          <ui-select multiple data-ng-model="email.idMta" theme="bootstrap" sortable="false" close-on-select="true">
                            <ui-select-match >{{"{{$item.name}}"}}</ui-select-match>
                            <ui-select-choices repeat="key.idMta as key in listmta | propsFilter: {name: $select.search}">
                              <div ng-bind-html="key.name | highlight: $select.search"></div>
                            </ui-select-choices>
                      ...
                      <div class="form-group">
                        <label for="urldomain" class="col-sm-3 control-label">*Urldomain</label>
                        <div class="col-sm-9">
                          <ui-select multiple data-ng-model="email.idUrldomain" theme="bootstrap" sortable="false" close-on-select="true">
                            <ui-select-match >{{"{{$item.name}}"}}</ui-select-match>
                            <ui-select-choices repeat="key.idUrldomain as key in listurldomain | propsFilter: {name: $select.search}">
                              <div ng-bind-html="key.name | highlight: $select.search"></div>
                            </ui-select-choices>
                      ...
                      <div class="form-group">
                        <label for="mailclass" class="col-sm-3 control-label">*Mailclass</label>
                        <div class="col-sm-9">
                          <ui-select multiple data-ng-model="email.idMailClass" theme="bootstrap" sortable="false" close-on-select="true">
                            <ui-select-match >{{"{{$item.name}}"}}</ui-select-match>
                            <ui-select-choices repeat="key.idMailClass as key in listmailclass | propsFilter: {name: $select.search}">
                              <div ng-bind-html="key.name | highlight: $select.search"></div>
                            </ui-select-choices>
