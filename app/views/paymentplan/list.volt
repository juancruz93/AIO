<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
        ...
        <hr class="basic-line">
        <p>
            Aquí encontrará el listado de planes de pago, que se usarán para el cobro de los servicios de la plataforma
        </p>            
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap text-right">
        ...
        <a href="{{url("paymentplan#/create")}}" class="shining btn success-inverted">Crear nuevo plan de pago</a>
    </div>
</div>
            ...
            <table class="table table-bordered sticky-enabled">
                ...
                <tbody>
                    <tr data-ng-repeat="i in list.items" data-ng-class="i.status == 0 ? 'danger':''">
                        ...
                        <td>
                            <span style="font-size: 2em;">{{"{{i.diskSpace}}"}} MB</span><br>
                            <b data-ng-if="i.listppxs.length > 0">Servicios:</b>
                            <ul>
                                <li data-ng-repeat="j in i.listppxs">{{"{{j.Service}}"}}</li>
                            </ul>
                        </td>
                        <td style="font-size: 2em;" >
                            {{"{{i.type == 'public' ? 'Público' : 'Privado'}}"}}
                        </td>
                        <td class="text-right">
                            <a href="" class="button shining btn btn-xs-round shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Editar tipo de moneda" data-ng-click="openMod(i.idPaymentPlan);">
                                <i class="fa fa-trash"></i>
                            </a>
                            <a href="{{url('paymentplan#/edit')}}/{{"{{i.idPaymentPlan}}"}}" class="button shining btn btn-xs-round shining-round round-button info-inverted" data-toggle="tooltip" data-placement="top" title="Editar impuesto">
                                <i class="fa fa-pencil"></i>
                            </a>
                            <a href="{{url('paymentplan#/show')}}/{{"{{i.idPaymentPlan}}"}}" class="button shining btn btn-xs-round shining-round round-button primary-inverted" data-toggle="tooltip" data-placement="top" title="Ver detalle">
                                <i class="fa fa-eye"></i>
                            </a>
                        </td>
                    </tr>
        ...
        <div class="Fcol-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
            <div class="block block-success">
                <div class="body success-no-hover text-center">
                    <h2>
                        No hay registros de planes de pago que coincidan con los filtros, para crear una haga <a href="{{url("paymentplan#/create")}}"><u>Click aquí</u></a>.
                    </h2>    
                    </h2>    
                </div>
            </div>
...
<div id="somedialog" class="dialog">
    ...
    <div class="dialog__content">
        ...
        <div class="dialog-inner">
            <h2>¿Esta seguro?</h2>
            <div>
                Debe tener en cuenta que si elimina el impuesto ya no lo podrá volver a utilizar ni ver.
            </div>
            <br>
            <div>
                <a onClick="closeModal();" class="button shining btn btn-md danger-inverted" data-dialog-close>Cancelar</a>
                <a href="#/" data-ng-click="deletePaymentPlan()" id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar</a>
            </div>
        </div>
    </div>
</div>
