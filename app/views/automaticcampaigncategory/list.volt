<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
    <div class="title">
      Lista de categorías de automatización de campaña
    </div>            
    <hr class="basic-line">
    <p>
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap ">   
      ...
      <div class="form-inline">
        <div class="form-group">
          <div class="input-group">
            <input type="text" class="undeline-input form-control" id="exampleInputAmount" placeholder="Buscar por nombre" autofocus="true" data-ng-model="filter.name" data-ng-keyup="filtername()">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right none-padding">
      <a href="automaticcampaign#/" class="button shining btn btn-sm default-inverted">Regresar</a>
    ...
    <table class="table table-bordered sticky-enabled">
      ...
      <tbody>
        <tr data-ng-repeat="i in list.items">
          ...
          <td>
            <a href="" class="button shining btn btn-xs-round shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="left" title="Eliminar contacto" data-ng-click="confirmDelete(i.idAutomaticCampaignCategory)">
              <span class="glyphicon glyphicon-trash"></span>
            </a>
            <a href="{{url('automaticcampaigncategory#/edit')}}/{{"{{i.idAutomaticCampaignCategory}}"}}" class="button shining btn btn-xs-round shining-round round-button info-inverted" data-toggle="tooltip" data-placement="top" title="Editar categoría">
  ...
  <div class="dialog__content">
    ...
    <div class="dialog-inner">
      ...
      <div>
        ...
        <a href="#/" data-ng-click="deleteAutocampcateg()" id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar</a>
      </div>
    </div>
  </div>
</div>
