    ...
    <form>
      <div class="block block-info">
          ...
          <div class="col-md-12">
            <div class="body form-horizontal">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="undeline-input form-control" id="nametempsms" name="nametempsms" maxlength="45" minlength="2" autofocus data-ng-model="nametempsms">
                  <div class="text-right" data-ng-class="nametempsms.length > 45 ? 'negative':''">{{"{{nametempsms.length > 0 ?  nametempsms.length+'/45':''}}"}}</div>
                </div>
              </div>
              <div class="form-group" data-ng-show="!newcategorytemplatesms">
                ...
                <div class="col-sm-9">
                  <select class="chosen form-control input-lg" style="width: 100%" data-ng-model="smstempcateg" id="smstemplatecategory">
                    <option value=""></option>
              ...
              <div class="form-group" data-ng-show="newcategorytemplatesms">
                ...
                <div class="col-sm-8">
                  ...
                  <div class="text-right" data-ng-class="newsmstempcateg.length > 80 ? 'negative':''">{{"{{newsmstempcateg.length > 0 ?  newsmstempcateg.length+'/80':''}}"}}</div>
                </div>
             ...
             <div class="form-group" ng-cloak>
                  ...
                  <div class="col-sm-1">
                    <div class="onoffswitch">
                      <input type="checkbox" name="morecaracter" ng-model="morecaracter" class="onoffswitch-checkbox" id="morecaracter" ng-click="opeModalMoreCa()">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea class="undeline-input form-control" id="contenttempsms" style="resize: none;" name="contenttempsms" maxlength="{{'{{morecaracter == true ? 300:160 }}'}}" minlength="1" rows="3" data-ng-model="contenttempsms" ng-change="validateContent();validateInLine()"></textarea>
                    
                    <div class="text-right" ng-hide='morecaracter' data-ng-class="contenttempsms.length > 160 ? 'negative':''">{{"{{contenttempsms.length > 0 ?  contenttempsms.length+'/160 aproximadamente':''}}"}} </div>                
                    <div class="text-right" ng-show='morecaracter' data-ng-class="contenttempsms.length > 300 ? 'negative':''">{{"{{contenttempsms.length > 0 ?  contenttempsms.length+'/300 aproximadamente':''}}"}} </div>
                  ...
                  <h6 class="color-warning" ng-show='existTags == true && morecaracter == true'>Si personaliza el mensaje SMS y éste excede los 300 caracteres permitidos será cortado en el momento del envío</h6>
        ...
        <div class="footer text-right">
          <button type="button" class="button shining btn btn-xs-round shining shining-round round-button success-inverted" data-toggle="tooltip" data-placement="top" title="Guardar" data-ng-click="saveSmsTemplate()">
          ...
          <a ng-show="contenttempsms" ng-click="openPreview()" class="button shining btn btn-xs-round shining-round round-button success-inverted" data-toggle="tooltip" data-placement="top" title="Visualizar">
