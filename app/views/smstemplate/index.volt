...
{#  {{ javascript_include('js/angular/smstemplate/app.js') }} #}
{# {{ javascript_include('js/angular/smstemplate/controller.js') }} #}
{{ javascript_include('js/angular/smstemplate/dist/smstemplate.018b6da1f3da6ad86e71.min.js ') }}
{# {{ javascript_include('js/angular/smstemplate/services.js') }} #}
