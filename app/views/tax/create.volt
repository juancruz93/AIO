...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap">
        <form data-ng-submit="saveTax()">
            <div class="block block-info">
                <div class="body row">
                    <div class="col-md-12">
                        <div class="body form-horizontal">
                            <div class="form-group">
                                <label for="idCountry" class="col-sm-4 control-label">*País</label>
                                <div class="col-sm-8">
                                    {#
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-4 control-label">{{form.label('name')}}</label>
                                <div class="col-sm-8">
                                    {{form.render('name')}}
                            ...
                            <div class="form-group">
                                <label for="type" class="col-sm-4 control-label">{{form.label('type')}}</label>
                                <div class="col-sm-8">
                                    {#
                                    {{form.render('type')}}
                                    #}
                            ...
                            <div class="form-group">
                                <label for="description" class="col-sm-4 control-label">{{form.label('description')}}</label>
                                <div class="col-sm-8">
        ...
        <div class="fill-block fill-block-info">
            ...
            <div class="body">
                ...
                <ul>                            
                    ...
                    <li><p>Debe seleccionar el tipo de impuesto el cual puede ser en porcentaje o el valor neto.</p></li>
