...
{% block content %}
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
      <div class="title">
        Creación de SMS por lista de contacto o segmentos.
      </div>
      <hr class="basic-line"/>
    </div>
  </div>
  <div class="row" ng-app="aio" ng-controller="smsContact">
      ...
      <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 wrap">
        <div class="block block-info">          
            ...
            <div class="row">
             ...
             <div class="form-group" ng-cloak>
              ...
              <div class="form-group" ng-show="showAddressee">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                  <label class="col-sm-4 col-md-4 text-right">Seleccionar {{"{{data.listSelected.id == 1 ? 'todas las' : 'todos los'}}"}} {{"{{data.listSelected.name}}"}}</label>
                  <div class="input hoshi input-default col-sm-1 ">
                    <div class="onoffswitch">
                      <input type="checkbox" name="sentNow" ng-model="allList" data-ng-change="selectAllList()" class="onoffswitch-checkbox" id="allList">
                      <label class="onoffswitch-label" for="allList">
                        <span class="onoffswitch-inner"></span>
                        <span class="onoffswitch-switch"></span>
                      </label>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg wrap">
                  ...
                  <div class="col-sm-1">
                    <div class="onoffswitch">
                      <input type="checkbox" name="sentNow" ng-model="viewTemplate" class="onoffswitch-checkbox" id="viewTemplate">
                      <label class="onoffswitch-label" for="viewTemplate">
                        <span class="onoffswitch-inner"></span>
                        <span class="onoffswitch-switch"></span>
                      </label>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg wrap" data-ng-show="viewTemplate">
                  <label class="col-sm-4 text-right">Elegir plantilla</label>
                  <div class="col-sm-8" data-ng-click="">
                    <select class="form-control select2" data-placeholder="Seleccione una de las plantillas" style="width: 100%" data-ng-model="idSmsTemplate" data-ng-change="useTemplate()">
                      <option value=""></option>
                      <option ng-repeat="i in listfullsmstemplate" value="{{"{{i.idSmsTemplate}}"}}">{{"{{i.name}}"}}</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap" ng-show="countContactsApproximate.counts>0"> 
                  ...
                  <div class="col-sm-8 col-md-8">
                    <textarea ng-model="data.message" id="message" class="form-control" rows="5" maxlength="{{'{{morecaracter == true ? 300:160 }}'}}" style="resize: none;" ng-change="validateInLine()"></textarea>
                    ...
                    <div class="text-right" ng-show="morecaracter" data-ng-class="(data.message.length > 300 && morecaracter == true) ? 'negative':''">{{"{{data.message.length > 0 ?  data.message.length+'/300':''}}"}}</div>
                    ...
                    <h6 class="color-warning" ng-show='existTags == true && morecaracter == false'>Si personaliza el mensaje SMS y éste excede los 160 caracteres permitidos será cortado en el momento del envío</h6>
                  </div>
                </div>
              ...
              <div class="form-group" ng-cloak>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                  ...
                  <div class="col-sm-1">
                    <div class="onoffswitch">
                      <input type="checkbox" name="sentNow" ng-model="advancedoptions" class="onoffswitch-checkbox" id="advancedoptions">
              ...
              <div ng-show="advancedoptions" class="advancedoptions-container">
                ...
                <div class="form-group" ng-cloak>
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <div class="col-sm-1">
                      <div class="onoffswitch">
                        <input type="checkbox" name="sentNow" ng-model="not"  class="onoffswitch-checkbox" id="not" ng-required="not">
                ...
                {% if idAccount == 49 or idAccount == '49' or idAccount == 101 or idAccount == '101' or idAccount == 1387 or idAccount == '1387' %}
                  ...
                  <div class="form-group" ng-cloak>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                      ...
                      <div class="col-sm-1">
                        <div class="onoffswitch">
                          <input type="checkbox" name="sentNow" ng-model="divide" class="onoffswitch-checkbox" id="divide">
                  ...
                  <div class="form-group" ng-cloak data-ng-show="divide">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                      <label class="col-sm-4 col-md-4 text-right">¿Continuar si hay errores?:</label>
                      <div class="col-sm-1">
                        <div class="onoffswitch">
                          <input type="checkbox" name="sentNow" ng-model="continueError"  class="onoffswitch-checkbox" id="continueError">
                          <label class="onoffswitch-label" for="continueError">
                            <span class="onoffswitch-inner"></span>
                            <span class="onoffswitch-switch"></span>
                          </label>
                        </div>
                ...
                {% endif %}
                {#
                <div id="divide-container" data-ng-show="divide">
                  <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
          ...
          <div class="footer" align="right">   
            <button id="submitButton" class="button shining btn btn-xs-round shining shining-round round-button success-inverted" ng-disabled="(countContactsApproximate.counts>40000 && data.divide == false) || countError " data-toggle="tooltip" data-placement="top" title="Guardar">
            ...
            {#<a ng-show="data.message" ng-click="openPreview()" class="button shining btn btn-xs-round shining-round round-button success-inverted" data-toggle="tooltip" data-placement="top" title="Visualizar">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap">                            
      <div class="fill-block fill-block-info" >
        ...
        <div class="body">
          ...
          <ul>
            <li>El nombre no puede tener menos de 5 caracteres ni más de 60 caracteres.</li>
        ...
        <div ng-if="initProcessValidate">
          <div class="dialog-inner">
            ...
            <div>
              ...
              <div class="text-left">
                <ul>
                  <li>Cantidad de registros inválidos: {{'{{invalicount}}'}}</li>
                </ul>
              </div>
            </div>
            <div>
              <div  ng-class="'text-success'" class="text-left "><i ng-class="'glyphicon glyphicon-ok-circle'"></i>Envíos programados</div>
              <div class="text-left">
                <ul>
                  <li>Total registros para envío: {{'{{validcount}}'}}</li>
                </ul>
              </div>
            </div>
            ...
            <div>   
              ...
              <a ng-click="validatecreate();{#addDisabled('btn-ok')#}"  id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar Envío</a>
            </div>
      ...
      <div class="dialog__content">
        <div ng-if="!initProcessValidate">
          <div class="dialog-inner">
            ...
            <p>Se realizará un envío de <b> {{"{{countContactsApproximate.counts  }}"}}</b> SMS</p>

            <div layout="row" layout-sm="column" layout-align="space-around" style="width: 325px; padding-left: 110px;">
              <md-checkbox class="md-warn" ng-model="switchrepeated" required ng-change="switchrepeatedclic(switchrepeated);">
                  <p id="repe1" style="display:block;margin-top: 12px">SMS único por contacto</p>
                  <p id="repe2" style="display:none;margin-top: 12px">SMS repetido en listas</p>
              </md-checkbox>
            </div>
            
            <h4>¿Desea validar el envío?</h4>
            <h6><i>Este proceso de validación puede durar aproximadamente 3 minutos.</i></h6>
            <div>                    
              <a onClick="closeModal();" class="button shining btn btn-md danger-inverted" data-dialog-close>Cancelar</a>
              <a ng-click="createcontact();"  id="btn-ok" class="button shining btn btn-md success-inverted" ng-disable="(idSubaccount!=28) || (misc.totalAvailable<countContactsApproximate.counts) || (countContactsApproximate.counts>40000 && data.divide == false) || disabled || countError ">Validar Envío</a>
            </div>
            <br>
            <div ng-show="balanceCSV" class="text-warning text-center">
              <i class="glyphicon glyphicon-warning-sign"></i>
              <h5>Usted no tiene suficiente saldo para realizar este envío</h5>
              <div class="row">
                <div class="col-sm-6" style="font-size:12px;text-align: center">Total SMS en Campañas Programadas: <b>{{'{{misc.tempSumSmsPendingTarget}}'}}</b></div>
                <div class="col-sm-6" style="font-size:12px;text-align: center">Saldo neto disponible: <b>{{'{{misc.totalAvailable}}'}}</b> </div>
              </div>
              <br>
              <div class="row">
                <div class="col-sm-6" style="font-size:12px;text-align: center">Cantidad Contactos campaña actual: <b>{{'{{countContactsApproximate.counts}}'}}</b></div>
                <div class="col-sm-6" style="font-size:12px;text-align: center">Cantidad de SMS a recargar para este envío: <b>{{'{{countContactsApproximate.counts - misc.totalAvailable}}'}}</b></div>
              </div>
