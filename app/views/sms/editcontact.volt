                            ...
                            <div class="form-group" ng-show="showAddressee">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap"> 
                                    ...
                                    <span class="input hoshi input-default col-sm-8 col-md-8">
                                        ...
                                        <div class="text-left" ng-show="countContactsApproximate.counts && morecaracter == false" ><p class="negative" style="font-size: 0.85em; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif; margin-top: 1em;">*Si <b>personaliza</b> el mensaje SMS y éste excede los 160 caracteres permitidos será cortado en el momento del envío</p></div>
                                        <div class="text-left" ng-show="countContactsApproximate.counts && morecaracter == true" ><p class="negative" style="font-size: 0.85em; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif; margin-top: 1em;">*Si <b>personaliza</b> el mensaje SMS y éste excede los 300 caracteres permitidos será cortado en el momento del envío</p></div>
            ...
            <div class="fill-block fill-block-info" >
                ...
                <div class="body">
                    ...
                    <ul>
                        ...
                        <li>Los correos deben estar separados por coma "," maximo 8 correos, donde se enviará la notificación cuando finalice el envío.</li>
      ...
      <div class="dialog__content">
        <div ng-if="!initProcessValidate">
          <div class="dialog-inner">
            ...
            <p>Se realizará un envío de {{"{{countContactsApproximate.counts  }}"}} SMS</p>
            ...
            <div layout="row" layout-sm="column" layout-align="space-around" style="width: 350px;padding-left: 110px;">
              <md-checkbox class="md-warn" ng-model="switchrepeated" required ng-change="switchrepeatedclic(switchrepeated);">
                <div>
                  <p id="repe1" style="display:block">SMS único por contacto</p>
                  <p id="repe2" style="display:none">SMS repetido en listas</p>
                </div>
              </md-checkbox>
            </div>

            <h2>¿Desea validar el envió?</h2>
            <div>                    
              <a onClick="closeModal();" class="button shining btn btn-md danger-inverted" data-dialog-close>Cancelar</a>
              <a ng-click="editContact();"  id="btn-ok" class="button shining btn btn-md success-inverted">Validar Envío</a>
            </div>
          </div>
        </div>
      </div>
