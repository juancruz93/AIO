...
{% block js %}
  ...
  <script type="text/javascript">
    ...
    var idSubaccountLogin = {{user.Usertype.idSubaccount}};
    var loadGetAll = 'createcsv';
  </script>
...
{% block content %}
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
      <div class="title">
        Creación de un SMS desde un archivo CSV
      </div>
      <hr class="basic-line"/>
    </div>
  </div>
  ...
  <div class="row" ng-app="aio" ng-controller="ctrlSms">
    <form id="form"  class="form-horizontal"> {#action="{{url("sms/createcsv") }}"#}
      <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 wrap">
        <div class="block block-info">          
          <div class="body " >
            <div class="row">
              ...
              <div class="form-group">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                  ...
                  <span class="input hoshi input-default col-sm-8 col-md-8">
                    {{ smsloteform.render('name', {'class': 'undeline-input' , 'placeholder':'*Nombre'  }) }}
                  </span>
                </div>
              </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                  ...
                  <div class="col-sm-1">
                    <div class="onoffswitch">
                      <input type="checkbox" name="sendnow" ng-model="datenow" class="onoffswitch-checkbox" id="datenow">
             ...
             <div class="form-group" ng-cloak>
              ...
              <div class="form-group">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                  <label class="col-sm-4 col-md-4 text-right">*Archivo CSV:</label>
                  <span class="input hoshi input-default col-sm-8 col-md-8">
                    {{ smsloteform.render('csv', {'class': 'undeline-input',  'required': 'required'  }) }}
                  </span>
                </div>
              </div>
              ...
              <div class="form-group" ng-cloak>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                  ...
                  <div class="col-sm-1">
                    <div class="onoffswitch">
                      <input type="checkbox" name="advancedoptions"  ng-model="advancedoptions" class="onoffswitch-checkbox" id="advancedoptions" >
              ...
              <div ng-show="advancedoptions" class="advancedoptions-container" ng-cloak>
                ...
                <div class="form-group" ng-cloak>
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <div class="col-sm-1">
                      <div class="onoffswitch">
                        <input type="checkbox" name="notification" ng-model="not"  class="onoffswitch-checkbox" id="not">
            ...
            {#    <div class="form-group" ng-cloak>
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <span class="input hoshi input-default col-sm-1 col-md-1"  ng-click="divideSending()">
                      {{ smsloteform.render('divide', {'id': 'toggle-four' , 'name': 'divide', 'ng-model': 'notification', 'ng-click': 'divideSending()' }) }}
                    </span>
                  </div>
                </div>#}
          ...
          <div class="footer" align="right">                        
            {#<a href="{{url('sms' )}}" class="button  btn btn-xs danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
              <span >Cancelar</span>
            </a>
            <button class="button shining btn btn-xs success-inverted" data-toggle="tooltip" data-placement="top" title="Guardar">
              <span >Continuar</span>
            </button>#}
            <button id="savecsv" class="button shining btn btn-xs-round shining shining-round round-button success-inverted" data-toggle="tooltip" data-placement="top" title="Guardar" ng-click='validateprocess()'>
              <span class="glyphicon glyphicon-ok"></span>
            </button>
            <button id="savechange" class="button shining btn btn-xs-round shining shining-round round-button success-inverted" data-toggle="tooltip" data-placement="top" title="Guardar" style="display:none;" disabled>
              <span class="glyphicon glyphicon-ok"></span>           
            </button>
      ...
      <div class="fill-block fill-block-info" >
        ...
        <div class="body">
          ...
          <ul>
            ...
            <li>Los correos electrónicos donde se va a notificar el envío se deben de separar por coma "," y máximo son 8 correos</li>
            <li>El archivo CSV no debe pesar más de 2 MB</li>
            <li>El archivo CSV debe de tener la siguiente estructura (código del país; número telefónico; mensaje) separados por punto y coma (;)</li>
            <li>El archivo CSV debe de contener al menos un destinatario valido</li>
            <li>El código del país no debe tener el signo "+"</li>
    ...
    <div id="somedialog" class="dialog">
      ...
      <div class="dialog__content">
        ...
        <div class="dialog-inner">
          <p ng-show="error == 0">Se van a almacenar {{ "{{success}}"}} SMS</p>
          <p ng-show="error != 0">La plataforma encontro {{"{{error}}"}} registro(s) malo si continua no se enviara SMS a estos destinatario(s)</p>
      ...
      <div class="dialog__content">
        ...
        <div class="dialog-inner">
          ...
          <div ng-if ="misc.ProccessCsv.finish" >
            ...
            <div class="smsContent" style="height:auto">
              {{'{{misc.ProccessCsv.finish.message}}'}}
            </div>
            <div ng-show="balanceCSV" class="text-warning text-center">
              <i class="glyphicon glyphicon-warning-sign"></i>
              <h4>Usted no tiene suficiente saldo para realizar este envío</h4>
            </div>
            <hr>
            <div>                    
              <a {#ng-click="changeStatusCsv('canceled');"#} ng-click="cancelSmsAndDeleteLotes();" onclick="closeModal();" class="button shining btn btn-md danger-inverted" data-dialog-close>Cancelar Envio</a>
              <!-- a ng-click="changeStatusCsv('canceled');" {#onclick="closeModal()"#} class="button shining btn btn-md danger-inverted" data-dialog-close>Cancelar Envio</a -->
              <a ng-show="!balanceCSV" ng-click="changeStatusCsv('scheduled');"  id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar Envio</a>
            </div>
          </div>
        </div>
      </div>
