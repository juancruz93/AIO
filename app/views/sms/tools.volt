    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
      <div class="body row text-center">
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2 col-lg-offset-3">
          <ul class="ch-grid ">
            <li>
              <div class="ch-item smsxlote pointer-cursor margin-botton">
                <a href="{{ url('sms/createlote')}}">
                  <div class="ch-info">
                    <h3>Crear envío rapido de SMS</h3>
                  </div>
                </a>
              </div>
              <b>Crear envío rapido de SMS</b>
            </li>
          </ul>
        </div>
          ...
          <ul class="ch-grid">
            <li >
              <div class="ch-item smsxcsv pointer-cursor margin-botton">
                <a href="{{url('sms/createcsv')}}" class="text-center">
                  <div class="ch-info">
                    <h3>Crear envio SMS desde archivo CSV</h3>
                  </div>
                </a>
              </div>
              <b>Crear envio SMS desde archivo CSV</b>
            </li>
          </ul>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
          <ul class="ch-grid">
            <li>
              ...
              <div class="ch-item smsxlista pointer-cursor margin-botton">
                <a href="{{url('sms/createcontact')}}" class="text-center" >
                  <div class="ch-info">
                    <h3>Crear envío SMS por lista de contacto o segmento</h3>
                  </div>
                </a>
              </div>
              <b>Crear envío SMS por lista de contacto o segmento</b>
            </li>
          </ul>
        </div>
      </div>
