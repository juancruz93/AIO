        ...
        <div class="body row">
          <div class="col-md-12">
            <div class="body form-horizontal">
              ...
              <div class="form-group">
                <label for="indicative" class="col-sm-2 control-label">Indicativo</label>
                <div class="col-sm-10">
                  <ui-select data-ng-model="data.idCountry" theme="select2" style="width: 100%" title="Seleccione un rol" data-ng-required ui-select-required>
                    <ui-select-match placeholder="Seleccione un indicativo">{{"{{$select.selected.name}}"}}</ui-select-match>
                  ...
                  <div class="col-md-12">
                    <div class="body form-horizontal">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <ui-select data-ng-model="form.idAdapter" on-select="selectAdapter($item,$index)" theme="select2" style="width: 100%" title="Seleccione un rol">
    ...
    <div class="fill-block fill-block-primary">
      ...
      <div class="body">
        ...
        <ul>
          ...
          <li>Cada regla debe tener al menos una configuración. Puede agregar hasta 20.</li>
          <li>
