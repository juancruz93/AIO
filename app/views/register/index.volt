...
{% block js %}
  ...
  {# {{ javascript_include('js/angular/register/app.js') }}
  {{ javascript_include('js/angular/register/controllers.js') }}
  {{ javascript_include('js/angular/register/services.js') }} #}
  {{ javascript_include('js/angular/register/dist/register.89e52cfdba220f02637b.min.js') }}
