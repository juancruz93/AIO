<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
    ...
    <hr class="basic-line">
    <p>
      Los nombres de remitentes los visualiza al momento de crear un envió de correo, sujeto de la persona que esta enviando el correo se describe como nombre de remitente.
    </p>            
  </div>
</div>
<div class="row" >
  <div class="col-xs-3 col-sm-3 col-lg-3 wrap">
    <div class="input-group">
      <input class="form-control"  id="name" ng-change="restServices.listnamesender()" placeholder="Buscar por nombre" ng-model="data.filter.name" />
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap text-right">
    ...
    <a href="#/create" class="button shining btn btn-sm success-inverted">Crear un nuevo nombre remitente</a>
  </div>
</div>
...
<div class="row" >
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap" ng-show="misc.list.items.length > 0">
    <table class="table table-bordered sticky-enabled">
      ...
      <tbody>
        <tr class="repeat-item" data-ng-repeat="i in misc.list.items track by i.idNameSender" data-ng-class="i.status == 0 ? 'danger letter-no-hover':''">
          <td style="width: 40%">
          ...
          <td class="text-right">
            <a href="" data-ng-click="functions.confirmDelete(i.idNameSender)" class="button shining btn btn-xs-round shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="left" title="Eliminar" >
              <span class="glyphicon glyphicon-trash"></span>
            </a>
            <a href="{{url('namesender#/edit')}}/{{"{{i.idNameSender}}"}}" class="button shining btn btn-xs-round shining-round round-button info-inverted" data-toggle="tooltip" data-placement="top" title="Editar nombre">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
      <div class="block block-success">
        <div class="body success-no-hover text-center">
          <h2>
            No hay registros nombres de remitentes que coincidan con los filtros, para crear uno nuevo <a href="#/create"><u>Clic aquí</u></a>.
          </h2>    
          </h2>    
        </div>
      </div>
...
<div id="somedialog" class="dialog ng-scope">
  ...
  <div class="dialog__content">
    ...
    <div class="dialog-inner">
      <h2>¿Esta seguro?</h2>
      <div>
        Debe tener en cuenta que si elimina el nombre de remitente ya no lo podrá volver a utilizar ni ver
      </div>
      <br>
      <div>
        <a onclick="closeModal();" class="button shining btn btn-md danger-inverted" data-dialog-close="">Cancelar</a>
        <a href="#/" data-ng-click="restServices.deletenamesender()" id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar</a>
      </div>
    </div>
  </div>
</div>
