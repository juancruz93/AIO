...
{% block js %}
  ...
  {# controladores angular namesender   #}
  {{ javascript_include('js/angular/namesender/services.js') }}
  {{ javascript_include('js/angular/namesender/controller.js') }}
  {{ javascript_include('js/angular/namesender/app.js') }}
{% endblock %}
