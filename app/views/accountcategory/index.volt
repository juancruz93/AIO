...
{% block js %}
    ...
    {{ javascript_include('js/angular/accountcategory/app.js') }}
    {{ javascript_include('js/angular/accountcategory/controllers.js') }}
    {{ javascript_include('js/angular/accountcategory/services.js') }}
...
{% block footer %}
    ...
    <script type="text/javascript">
        ...
        var templateBase = "accountcategory";
    </script>
