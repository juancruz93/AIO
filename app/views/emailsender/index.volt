...
{% block js %}
  ...
  {{ javascript_include('js/angular/emailsender/services.js') }}
  {{ javascript_include('js/angular/emailsender/controller.js') }}
  {{ javascript_include('js/angular/emailsender/app.js') }}
{% endblock %}
