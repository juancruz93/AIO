<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
    <div class="title">
      Lista correos de remitente
    </div>            
    <hr class="basic-line">
    <p>
      Correos de remitentes los cuales se visualiza al momento de crear un nuevo correo, estos correos hacen referencia a la persona que despacha y hace la función de emisor para enviar un correo.
    </p>            
  </div>
</div>
<div class="row" >
  <div class="col-xs-3 col-sm-3 col-lg-3 wrap">
    <div class="input-group">
      <input class="form-control"  id="name" ng-change="restServices.listemailsender()" placeholder="Buscar por nombre de correo" ng-model="data.filter.email" />
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap text-right">
    ...
    <a href="#/create" class="button shining btn btn-sm success-inverted">Crear un nuevo correo de remitente</a>
  </div>
</div>
...
<div class="row" >
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap" ng-show="misc.list.items.length > 0">
    <table class="table table-bordered sticky-enabled">
      ...
      <tbody>
        <tr class="repeat-item" data-ng-repeat="i in misc.list.items track by i.idEmailsender" data-ng-class="i.status == 0 ? 'danger letter-no-hover':''">
          <td style="width: 40%">
            <b class="medium-text">{{"{{i.email}}"}}</b><br>
          </td>
          <td>
          ...
          <td class="text-right">
            <a href="" data-ng-click="functions.confirmDelete(i.idEmailsender)" class="button shining btn btn-xs-round shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="left" title="Eliminar" >
              <span class="glyphicon glyphicon-trash"></span>
            </a>
            <a href="{{url('emailsender#/edit')}}/{{"{{i.idEmailsender}}"}}" class="button shining btn btn-xs-round shining-round round-button info-inverted" data-toggle="tooltip" data-placement="top" title="Editar correo remitente">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
      <div class="block block-success">
        <div class="body success-no-hover text-center">
          <h2>
            No hay registros de correos remitentes que coincidan con los filtros, para crear uno nuevo <a href="#/create"><u>Clic aquí</u></a>.
          </h2>    
          </h2>    
        </div>
      </div>
  ...
  <div class="dialog__content">
    ...
    <div class="dialog-inner">
      ...
      <div>
        ...
        <a href="#/" data-ng-click="restServices.deleteemailsender()" id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar</a>
      </div>
    </div>
  </div>
</div>
