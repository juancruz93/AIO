<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-7">
    <form name="contactlistForm" class="form-horizontal" role="form" ng-submit="functions.confirmSave()" >
      <div class="block block-info ">
        <div class="body row padding-right-30px " >
          <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 margin-top-15px ">
            ...
            {#   <div class="select-box">
                 <ui-select ng-model="segment.conditions" theme="select2"  class=''    style="width: 600px;"ng-required="true">
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                ...
                <div class="  col-sm-8">
                  <ui-select ng-model="segment.conditions" theme="select2"  class='select2 select2-container ng-empty ng-invalid ng-invalid-required ng-valid-maxlength undeline-input' style="padding: 0px; border-bottom: 0px;" ng-required="true">
                    <ui-select-match placeholder="---">{{"{{$select.selected}}"}}</ui-select-match>
                    <ui-select-choices repeat="key in [ 'Todas las condiciones',  'Algunas de las condiciones' ]">
                      <div ng-bind-html="key"></div>
                    </ui-select-choices>
          ...
          <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7  fill-block fill-block-info  wrap padding-top-15px margin-1-5" style="margin-top: 0">
            ...
            <div  ng-repeat="item in filters" class="row" ng-show='viewFilters'>
              <div class="form-group margin-botton-none wrap">

                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4  wrap ">
                  <ui-select ng-model="item.customfield" theme="select2" class='ui-select-container select2 select2-container ng-empty ng-invalid ng-invalid-required ng-valid-maxlength' style="width: 100%">
                    <ui-select-match placeholder="---">{{"{{$select.selected.name}}"}}</ui-select-match>
                    <ui-select-choices repeat="key as key in customfield | propsFilter: {name: $select.search}">
                      <div ng-bind-html="key.name | highlight: $select.search"></div>
                    </ui-select-choices>
                  </ui-select>
                </div>

                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-4 wrap" ng-if='item.customfield'>
                  <ui-select ng-model="item.conditions" theme="select2"   class='ui-select-container select2 select2-container ng-empty ng-invalid ng-invalid-required ng-valid-maxlength' style="width: 100%">
                    <ui-select-match placeholder="---">{{"{{$select.selected}}"}}</ui-select-match>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-3 wrap " ng-show="item.conditions">
                  <ui-select style="width: 80px;" ng-if="item.customfield.type == 'Select' " ng-model="item.value"  theme="select2"
                             class='ui-select-container select2 select2-container ng-empty ng-invalid ng-invalid-required ng-valid-maxlength' style="width: 100%">
                    <ui-select-match placeholder="---">{{"{{$select.selected}}"}}</ui-select-match>
                  ...
                  <input style="width: 80px;" ng-if="item.customfield.type == 'Numerical' "  placeholder="Valor" ng-model="item.value" type="number">

                  <input size="6" ng-if="item.customfield.type == 'Text' || item.customfield.type == 'TextArea' " class="form-control" placeholder="Valor" ng-model="item.value" >

                  <ui-select ng-if="item.customfield.type == 'Multiselect' " multiple='multiple' ng-model="item.value"  theme="bootstrap"
                  ...
                  <div  moment-picker="item.value"
                        format="YYYY-MM-DD"  ng-if="item.customfield.type == 'Date' ">
                    <input  size="6" class=""
                            placeholder="Fecha"
                            ng-model="item.value"
                ...
                <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 " ng-if="filters.length > 1">
        ...
        <div class="footer" align="right">
          ...
          <a href="#/" ng-disabled="!progressbar" class="button btn btn-xs-round danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
  ...
  <div class="dialog__content">
    <div class="dialog-inner">
      ...
      <div>
        ...
        <button type="button" data-ng-click="functions.addSegment() " id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar</button>
      </div>
    </div>
  </div>
</div>
