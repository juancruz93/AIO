...
{% block header %}
  ...
  {{ stylesheet_link('library/spectrum/css/spectrum.min.css') }}
  <link rel="stylesheet"
  ...
  {{ stylesheet_link('library/angular-xeditable-0.2.0/css/xeditable.min.css') }}
{% endblock %}
...
{% block js %}
  ...
  {{ javascript_include('js/angular/forms/dist/forms.29d2208f55d2dfbb76a9.min.js') }}
  {# {{ javascript_include('js/angular/forms/app.js') }}
  {{ javascript_include('js/angular/forms/controllers.js') }}
  {{ javascript_include('js/angular/forms/services.js') }} #}
  
  {#{{ javascript_include('js/angular/forms/app.min.js') }}
  {{ javascript_include('js/angular/forms/controllers.min.js') }}
  {{ javascript_include('js/angular/forms/services.min.js') }}#}
...
{#  {{ javascript_include('library/angular-form-builder-master/dist/angular-form-builder-components.min.js') }}#}
  {{ javascript_include('library/angular-form-builder-master/dist/angular-form-builder-components.js') }}
...
<div id="container-floating">
  <div class="nd1 nds" data-toggle="tooltip" data-placement="left" title="Youtube"><img class="reminder">
    ...
    <a href="https://www.youtube.com/playlist?list=PLruewKCYa5VtMPdcu9Ej68sr_ET7P3Kau" target="_blank">
