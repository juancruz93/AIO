<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
    <div class="title">
      Editar correo de respuesta <i>{{"{{data.email}}"}}</i>
    </div>
    <hr class="basic-line"/>
    <p>
      Correos de repuesta.
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-8 col-md-8">
                  <input type="text" maxlength="100" class="form-control" id="name" ng-model="misc.data.email">
                </span>
              </div>
            </div>
            <div class="form-group" >
  ...
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap">                            
    <div class="fill-block fill-block-info" >
      ...
      <div class="body">
        ...
        <ul>
          <li>El correo debe tener mínimo 2 y máximo 100 caracteres</li>
