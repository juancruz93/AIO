<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
    <div class="title">
      Lista correos de respuesta
    </div>            
    <hr class="basic-line">
    <p>
      Este listado de correos de respuesta hace referencia al "Responder a" al momento de crear un correo, quien responde un correo electrónico. 
    </p>            
  </div>
</div>
<div class="row" >
  <div class="col-xs-3 col-sm-3 col-lg-3 wrap">
    <div class="input-group">
      <input class="form-control"  id="name" ng-change="restServices.listreplyto()" placeholder="Buscar por nombre de correo" ng-model="data.filter.email" />
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap text-right">
    ...
    <a href="#/create" class="button shining btn btn-sm success-inverted">Crear un nuevo correo de respuesta</a>
  </div>
</div>
...
<div class="row" >
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap" ng-show="misc.list.items.length > 0">
    <table class="table table-bordered sticky-enabled">
      ...
      <tbody>
        <tr class="repeat-item" data-ng-repeat="i in misc.list.items track by i.idReplyTo" data-ng-class="i.status == 0 ? 'danger letter-no-hover':''">
          <td style="width: 40%">
          ...
          <td class="text-right">
            <a href="" data-ng-click="functions.confirmDelete(i.idReplyTo)" class="button shining btn btn-xs-round shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="left" title="Eliminar" >
              <span class="glyphicon glyphicon-trash"></span>
            </a>
            <a href="{{url('replyto#/edit')}}/{{"{{i.idReplyTo}}"}}" class="button shining btn btn-xs-round shining-round round-button info-inverted" data-toggle="tooltip" data-placement="top" title="Editar correo">
  ...
  <div class="dialog__content">
    ...
    <div class="dialog-inner">
      ...
      <div>
        ...
        <a href="#/" data-ng-click="restServices.deletereplyto()" id="btn-ok" class="button shining btn btn-md success-inverted">Confirmar</a>
      </div>
    </div>
  </div>
</div>
