...
{% block js %}
  ...
  {{ javascript_include('js/angular/wpptemplate/app.js') }}
 {{ javascript_include('js/angular/wpptemplate/controllers.js') }}
 {{ javascript_include('js/angular/wpptemplate/services.js') }}
