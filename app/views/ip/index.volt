...
{% block js %}
  ...
  {# controladores angular ip   #}
  {{ javascript_include('js/angular/ip/services.js') }}
  {{ javascript_include('js/angular/ip/controller.js') }}
  {{ javascript_include('js/angular/ip/app.js') }}
{% endblock %}
