...
<div class="row">
  ...
  <div class="col-xs-12 col-sm-6 col-md-6 text-right wrap">
    <a href="{{ url('mail/create#/content/') }}{{"{{idMail}}"}}" class="button shining btn btn-sm danger-inverted"><i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar</a>
  </div>
</div>
...
<div id="pagination" class="text-center" ng-show="list.items.length > 0">
  <ul class="pagination">
    <li ng-class="page == 1 ? 'disabled'  : ''">
      <a  href="#/select/{{"{{idMail}}"}}" ng-click="page == 1 ? true  : false || fastbackward()" class="new-element"><i class="disabled glyphicon glyphicon-fast-backward"></i></a>
    </li>
    <li  ng-class="page == 1 ? 'disabled'  : ''">
      <a href="#/select/{{"{{idMail}}"}}"  ng-click="page == 1 ? true  : false || backward()" class="new-element"><i class="glyphicon glyphicon-step-backward"></i></a>
    </li>
    <li>
    ...
    <li   ng-class="page == (list.total_pages)  || list.total_pages == 0  ? 'disabled'  : ''">
      <a href="#/select/{{"{{idMail}}"}}" ng-click="page == (list.total_pages)  || list.total_pages == 0  ? true  : false || forward()" class="new-element"><i class="glyphicon glyphicon-step-forward"></i></a>
    </li>
    <li   ng-class="page == (list.total_pages)  || list.total_pages == 0  ? 'disabled'  : ''">
            ...
            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3" data-ng-repeat="i in list.items">
              <div class="thumbnail">
                <div style="position: relative" class="text-center">
                  ...
                  <a href="{{url('mail/contenteditor')}}/{{'{{idMail}}'}}/0/{{'{{i.idMailTemplate}}'}}"><img src="{{url('')}}{{"{{i.dirImage}}"}}" /></a>
                  <div class="caption text-center">
                    <div><h4><b>{{"{{i.name}}"}}</b></h4>
                      ...
                      <div class="btn-group" role="group">
                          <a class="button btn alert-aoi-warning toltip" href="{{url('mail/contenteditor')}}/{{'{{idMail}}'}}/0/{{'{{i.idMailTemplate}}'}}" data-toggle="tooltip" data-placement="bottom" title="Seleccionar plantilla" >
