...
{% block content %}    
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
            <div class="title">
                Edición de la URL: <strong>{{urldomain.name}}</strong>
            </div>            
            <hr class="basic-line" />
        </div>
    </div>                                                          
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap"> 
            <form action="{{url('urldomain/edit')}}/{{urldomain.idUrldomain}}" method="post" class="form-horizontal">
                <div class="block block-info">
                    <div class="body">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                                ...
                                <div class="col-sm-8">                                  
                                    <input type="checkbox" id="toggle-one" name="status" {% if urldomain.status %} checked {% endif %}/>
                                </div>
                            </div>       
                        </div>
                    </div>                                            
                    ...
                    <div class="footer" align="right">                                                
                        ...
                        <a href = "{{url('urldomain/index')}}" class="button shining btn btn-xs-round shining shining-round round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
            ...
            <div class="fill-block fill-block-primary" >
                ...
                <div class="body">
                    ...
                    <ul>
                        ...
                        <li>El nombre de la URL debe llevar el https://</li>
                        <li>El nombre de la URL debe ser un nombre único, es decir, no pueden existir dos URL con el mismo nombre.</li>
