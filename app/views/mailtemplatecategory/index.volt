...
{% block js %}
  ...
  {# controladores angular mailtemplatecategory   #}
  {{ javascript_include('js/angular/mailtemplatecategory/services.js') }}
  {{ javascript_include('js/angular/mailtemplatecategory/controller.js') }}
  {{ javascript_include('js/angular/mailtemplatecategory/app.js') }}
{% endblock %}
