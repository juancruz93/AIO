...
{% block content %}    
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 wrap"> 
      <form action="{{url('user/passedit')}}/{{(userE.idUser)}}" method="post" class="form-horizontal">
        <div class="block block-info">
          ...
          <div class="footer" align="right">      
            ...
            <a href="{{url('user/index')}}" class="button  btn btn-xs-round round-button danger-inverted" data-toggle="tooltip" data-placement="top" title="Cancelar">
