...
{% block content %}
  ...
  <div ng-controller="indexController" ng-cloak>
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
        <div class="title">
          Lista de contactos <strong>{{"{{ contactlist.name }}"}}</strong>
        </div>
        <hr class="basic-line" />
      </div>
    </div>
    <div class="row wrap">
      <div class="div-border-thin " >
        <div class="col-lg-6 inline-block">
          ...
          <p>
            Categoría: <strong>{{"{{contactlist.category}}"}}</strong>
            <br>
            Creada por <strong>{{"{{ contactlist.createdBy }}"}}</strong> el dia <strong>{{"{{contactlist.created * 1000 | date:'dd/MM/yyyy h:mma'}}"}}</strong>
            <br>
            Actualizada por <strong>{{"{{ contactlist.updatedBy }}"}}</strong> el dia <strong>{{"{{ contactlist.updated * 1000 | date:'dd/MM/yyyy h:mma'}}"}}</strong>
          </p>
        </div>
        <div class="row wrap text-right">
          ...
          <div class="inline-block text-center none-padding">
            Bloqueados       <br>
            <span class="medium-text danger">{{"{{ contactlist.cblocked}}"}}</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="container-floating">
    ...
    <div class="nd1 nds" data-toggle="tooltip" data-placement="left" title="Youtube"><img class="reminder">
      ...
      <a href="https://www.youtube.com/playlist?list=PLruewKCYa5VvsV8sR_1R25BingxYIQSF1" target="_blank">
