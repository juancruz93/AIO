...
{% block js %}
  ...
  <!-- Smsxeamil -->
  {{ javascript_include('js/angular/smsxemail/services.js') }}
  {{ javascript_include('js/angular/smsxemail/controllers.js') }}
  {{ javascript_include('js/angular/smsxemail/app.js') }}
{% endblock %} 
{% block content %}
