...
{% block js %}
  ...
  {{ javascript_include('js/angular/history/app.js') }}
  {{ javascript_include('js/angular/history/controllers.js') }}
  {{ javascript_include('js/angular/history/directives.js') }}
  {{ javascript_include('js/angular/history/filters.js') }}
  {{ javascript_include('js/angular/history/services.js') }}
