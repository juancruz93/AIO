          ...
          <div class="row">
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-8 col-md-8">
                  <input type="text" maxlength="100" class="form-control" id="name" ng-model="data.name">
                </span>
              </div>
            </div>
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-8 col-md-8" style="margin-left: 48px;width: 395px;">
                  <ui-select style="max-width: 95%" multiple ng-model="data.ipdta" ng-required="true"  ui-select-required 
            ...
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-8 col-md-8">
                  <textarea class="form-control" maxlength="200" ng-model="data.description" rows="4"></textarea>
                </span>
              </div>
            </div>
            <div class="form-group">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                ...
                <span class="input hoshi input-default col-sm-8 col-md-8">
                  <textarea class="form-control" maxlength="200" ng-model="data.observation" rows="4"></textarea>
                </span>
              </div>
            </div>
          </div>
