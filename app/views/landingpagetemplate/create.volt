{% extends "templates/htmlbuilderTemplate.volt" %}
{% block header %}
  <script>
    var siteUrl = '';
    var baseUrl = '';
    var idGeneral
    = {{idLandingPageTemplate}};
...
{% endblock %}
{% block content %}
  <div data-ng-controller="createCtrl">
    <div id="builder">

      <div class="menu" id="menu">

        <div class="main" id="main">
          <figure class="fig-logo-aio">
            <img src="http://demosigmamovil.com/sigma/wp-content/uploads/2016/11/logo-aio.png" class="img-responsive" />
            {#<img src="{{url('images/aio.png')}}" class="img-responsive" />#}
          </figure>

          <h3>
            <span class="fui-list"></span> Bloques 
          </h3>

          <ul id="elementCats">
            <li><a href="#" id="all">Todos los bloques</a></li>
          </ul>
      ...
      <div class="container">
        ...
        <header class="clearfix affix">
          ...
          {#<a href="#exportModal" id="exportPage" data-toggle="modal" class="btn btn-inverse pull-right actionButtons nohover">
            <i class="fui-export"></i>
            <span>Export</span>
          </a>#}

          <a href="" id="saveAndContinue" data-toggle="modal" class="btn btn-info pull-right actionButtons nohover">
          ...
          <a href="" id="savePage" data-toggle="modal" class="btn btn-primary pull-right nohover">
            <i class="fui-check"></i>
            <span class="bLabel">Sin cambios</span>
          </a>
        ...
        <div class="screen" id="screen">
          ...
          <div id="frameWrapper" class="frameWrapper empty">
            ...
            <div class="start" id="start">
              <span>CONSTRUYA SU PÁGINA ARRASTRANDO LOS BLOQUES EN EL LIENZO</span>
            </div>
          </div>
      ...
      <div id="styleEditor" class="styleEditor">
        ...
        <h3><span class="fui-new"></span> Propiedades</h3>
        ...
        <ul class="nav nav-tabs" id="detailTabs">
          ...
          <li style="display: none;">
            <a href="#link_Tab" id="link_Link">
              <span class="fui-clip"></span> Enlace
            </a>
          </li>
          <li style="display: none;">
            <a href="#image_Tab" id="img_Link">
              <span class="fui-image"></span> Imagen
            </a>
          </li>
          <li style="display: none;">
            <a href="#icon_Tab" id="icon_Link">
              <span class="fa fa-flag"></span> Icono
            </a>
          </li>
          <li style="display: none;">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane imageFileTab" id="image_Tab">
            ...
            <label>Ingrese ruta de imagen:</label>
            ...
            <form id="imageUploadForm" action="{{url('api/landingpage/uploadimage')}}">
                ...
                <div class="fileinput fileinput-new" data-provides="fileinput">
                  ...
                  <div>
                    <span class="btn btn-primary btn-sm btn-embossed btn-file">
                      <span class="fileinput-new"><span class="fui-image"></span>&nbsp;&nbsp;Seleccionar imagen</span>
                      <span class="fileinput-exists"><span class="fui-gear"></span>&nbsp;&nbsp;Cambiar</span>
        ...
        <div class="margin-bottom-5">
          <button type="button" class="btn btn-primary btn-embossed btn-sm btn-block" id="saveStyling"><span class="fui-check-inverted"></span> Aplicar cambios</button>
        </div>
      ...
      <div id="hidden">
        <iframe src="{{url('library/htmlbuilder/elements/skeleton.html')}}" id="skeleton"></iframe>
      </div>
    ...
    <div class="modal fade small-modal" id="deleteBlock" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Cancelar y cerrar</button>
            <button type="button" type="button" class="btn btn-primary btn-embossed" id="deleteBlockConfirm">Eliminar</button>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <p>
              ¿Está seguro de que desea restablecer este bloque?
            </p>
            <p>
              Todos los cambios realizados en el contenido serán destruidos.
            </p>

          </div><!-- /.modal-body -->
          <div class="modal-footer">
            <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Cancelar cerrar</button>
            <button type="button" type="button" class="btn btn-primary btn-embossed" id="resetBlockConfirm">Restaurar bloque</button>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <p>
              ¿Seguro que quieres eliminar esta página completa?
            </p>

          </div><!-- /.modal-body -->
          <div class="modal-footer">
            <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal" id="deletePageCancel">Cancelar y cerrar</button>
            <button type="button" type="button" class="btn btn-primary btn-embossed" id="deletePageConfirm">Eliminar Página</button>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <p>
              ¿Esta seguro que quiere eliminar este elemento? Una vez eliminado, no se puede restaurar.
            </p>

          </div><!-- /.modal-body -->
          <div class="modal-footer">
            <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal" id="deletePageCancel">Cancelar y cerrar</button>
            <button type="button" type="button" class="btn btn-primary btn-embossed" id="deleteElementConfirm">Elimnar bloque</button>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    ...
    <div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <form action="[[urlactionForm]]" target="_blank" id="markupPreviewForm" method="post" class="form-horizontal">
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
              <h4 class="modal-title" id="myModalLabel"><span class="fui-window"></span> Previsualizar Página</h4>
            </div>

            <div class="modal-body">

              <p>
                Tenga en cuenta que los enlaces a otras páginas no funcionarán correctamente en la vista preliminar.
              </p>

            </div><!-- /.modal-body -->

            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal"><span class="fui-cross"></span> Cancelar & Cerrar</button>
              <button type="submit" class="btn btn-primary btn-embossed"><span class="fui-export"></span> Previsualizar Cambios</button>
            </div>
    ...
    <!-- Form create Template popup -->
    <div class="modal fade modal" id="formCreateTemplate" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      <form id="createTemplateForm" class="form-horizontal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel"><span class="fui-window"></span> Crear plantilla de Landing Page</h4>
            </div>
            <div class="modal-body">
              <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="undeline-input form-control" id="namelpt" name="name" maxlength="100" minlength="2" data-ng-model="data.name" autofocus />
                      <div class="text-right" data-ng-class="data.name.length > 35 ? 'negative':''">[[data.name.length > 0 ?  data.name.length+'/100':'']]</div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div id="categories" data-ng-show="misc.viewCategories">
                      <label for="category" class="col-sm-2 control-label">Categoría</label>
                      <div class="col-sm-9">
                        <ui-select ng-model="data.idLandingPageTemplateCategory" ng-required="true" ui-select-required theme="selectize" sortable="false" close-on-select="true">
                          <ui-select-match placeholder="Categorías">[[$select.selected.name]]</ui-select-match>
                          <ui-select-choices repeat="key.idLandingPageTemplateCategory as key in landingpagetempcategory | propsFilter: {name: $select.search}">
                            <div ng-bind-html="key.name | highlight: $select.search"></div>
                          </ui-select-choices>
                        </ui-select>
                      </div>
                      <div class="col-xs-1 col-sm-1">
                        <a class="positive" data-ng-click="functions.viewNewCategory()">
                          <i class="fa fa-plus fa-2x" style="margin-top: 5px; cursor: pointer"></i>
                        </a>
                      </div>
                    </div>
                    <div id="createCategory" data-ng-show="misc.viewNewCategory">
                      <label for="newCategory" class="col-sm-2 control-label">Crear categoría</label>
                      <div class="col-sm-8">
                        <input type="text" class="undeline-input form-control" placeholder="Nueva categoría" id="newCAtegory" name="newCategory" maxlength="100" minlength="2" data-ng-model="data.new.name" />
                      </div>
                      <div class="col-xs-2 col-sm-2">
                        <a class="positive" data-ng-click="functions.saveNewCategory()">
                          <i class="fa fa-check fa-2x" style="margin-top: 5px; cursor: pointer"></i>
                        </a>
                        <a class="negative" data-ng-click="functions.viewNewCategory()" style="color: #e74c3c">
                          <i class="fa fa-times fa-2x" style="margin-top: 5px; cursor: pointer"></i>
                        </a>
                      </div>
                    </div>
                  </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-embossed" id="cancelTemplate"><span class="fui-cross"></span> Cancelar & Cerrar</button>
              <button type="button" class="btn btn-primary btn-embossed" id="btnSubmitFormCreate"><span class="fui-export"></span> Guardar y editar plantilla</button>
            </div>
  ...
  {{ javascript_include('library/htmlbuilder/bundles/builder.bundle.min.js') }}
{% endblock %}
{% block js %}
  <!-- ui-select -->
  {{ javascript_include('library/ui-select-master/dist/select.js') }}

  {{ javascript_include('js/angular/landingpagetemplate/templateControllers.js') }}
{% endblock %}
