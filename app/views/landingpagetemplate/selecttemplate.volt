<style>
  .thumbnail:hover{
    ...
    background-color: rgba(255, 110, 0, .05);
  }
</style>
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
    <div class="title">
      Lista de plantillas  de Landing Page para seleccionar
    </div>
    <hr class="basic-line">
    <p>
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-lg-12 text-right wrap">
    <a href="{{ url('landingpage#/create/content/') }}[[data.params.idLandingPage]]" class="button shining btn btn default-inverted"><i class="fa fa-arrow-left"></i> Regresar</a>
    <button type="button" class="btn success-inverted" data-ng-click="functions.refresh()">
      <i class="fa fa-refresh"></i>
      <md-tooltip md-direction="bottom">Refrescar</md-tooltip> 
    </button>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3" data-ng-repeat="i in data.list.items track by $index">
    <div class="thumbnail" style="height: 280px; transition: all 0.2s ease-in-out;">
      <a href="{{url('api/lptemplate/select/')}}[[data.params.idLandingPage]]/[[i.idLandingPageTemplate]]">
      ...
      <div class="caption text-center">
        ...
        <div class="btn-group btn-group-sm" role="group">
          <a href="{{url('landingpagetemplate/preview/')}}[[i.idLandingPageTemplate]]" class="btn default-inverted" target="_blank">
            <i class="fa fa-eye"></i>
            <md-tooltip md-direction="bottom">
              Previsualizar
            </md-tooltip>
          </a>
          <a class="btn warning-inverted" href="{{url('api/lptemplate/select/')}}[[data.params.idLandingPage]]/[[i.idLandingPageTemplate]]" data-toggle="tooltip" data-placement="bottom" title="Seleccionar plantilla" >
