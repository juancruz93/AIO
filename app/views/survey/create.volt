...
{% block js %}
  ...
  {{ javascript_include('js/angular/survey/controllers.js') }}
  {{ javascript_include('js/angular/survey/services.js') }}#}
    ...
    <div id="form-container" ng-controller="main">
      ...
      <div class="text-center">
        <div id="status-buttons" class="">
          ...
          <a ui-sref="describe({idSurvey:idSurveyGet})" ng-class="{'active': route == 'describe'}" >
            <span>1</span> <b>Información básica</b></a>
          <a ui-sref="survey({idSurvey:idSurveyGet})" ng-class="{'active': route == 'survey'}">
            <span>2</span> <b>Diseñar encuesta</b>
          </a>
          <a ui-sref="confirmation({idSurvey:idSurveyGet})"  ng-class="{'active': route == 'confirmation'}" >
            <span>3</span> <b>Confirmar encuesta</b>
          </a>
          <a ui-sref="share({idSurvey:idSurveyGet})"  ng-class="{'active': route == 'share'} " >
            <span>4</span> <b>Compartir encuesta</b>
          </a>
        </div>
      </div>
...
{% block footer %}
  ...
  <script type="text/javascript">
    ...
    var d = new Date();
    var n = d.getTime();
    $.getScript(fullUrlBase + 'library/angular-form-builder-master/dist/angular-form-builder-v1.js?' + n, function () {
      angular.element(document).ready(function () {
        angular.bootstrap(document, ['survey'])
      });
    });
  </script>
