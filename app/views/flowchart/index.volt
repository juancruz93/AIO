<svg 
  ...
  <g
    ...
    ng-attr-class=""
    >
    <image svg-popover ng-model="node.data" ng-connections="chart.connections"  x="0" y="0" ng-attr-width="{{'{{node.width()}}'}}" ng-attr-height="{{'{{node.width()}}'}}" xlink:href="" ng-href="{{'{{node.image()}}'}}" />
    {#<text
      ng-attr-x="{{'{{node.widthTextTitle()}}'}}"
      y="15"
      text-anchor="start"
