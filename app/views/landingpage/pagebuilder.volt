...
{% block header %}
  <script>
    var siteUrl = '';
    var baseUrl = '';
    var idGeneral = {{idLandingPage}};
    var controllerName = '{{controllerName}}';
  </script>
{% endblock %}
{% block content %}
  <div data-ng-controller="pagebuilderController">
    <div id="builder">

      <div class="menu" id="menu">

        <div class="main" id="main">
          <figure class="fig-logo-aio" style="padding-left: 35px;">
    ...
    <div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <form action="{{url('landingpage/preview')}}/{{idLandingPage}}" target="_blank" id="markupPreviewForm" method="POST" class="form-horizontal">
  ...
  <script src="{{url('library/htmlbuilder/bundles/builder.bundle.min.js')}}" async="async"></script>
{% endblock%}
{% block js %}
  {{ javascript_include('js/angular/landingpage/pagebuilder/controllers.js') }}
  {{ javascript_include('js/angular/landingpage/pagebuilder/services.js') }}
{% endblock %}
