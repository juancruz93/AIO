...
{% endblock %}
{% block content %}    
  <div ng-app="mail_structure" ng-controller="ctrlCreate">
        ...
        <div class="block block-info">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-12">
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wrap">
                    ...
                    <textarea ng-model="data.category" class="form-control"></textarea>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="footer row none-margin">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
              ...
              <a
                class="button btn btn-small primary-inverted" data-ng-click="saveContent()"
                data-toggle="tooltip" data-placement="top"  title="Guardar y seguir editando">
                Guardar y seguir editando
              </a>
              <button type="submit" class="button btn btn-small success-inverted"  data-ng-click="saveContentExit()"
