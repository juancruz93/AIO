...
{#  cargando archivos propios#}
  
{# {{ javascript_include('js/angular/contactlist/app.js') }}
  {{ javascript_include('js/angular/contactlist/controllers.js') }}
  {{ javascript_include('js/angular/contactlist/directives.js') }}
  {{ javascript_include('js/angular/contactlist/filters.js') }}
  {{ javascript_include('js/angular/contactlist/services.js') }} #}

  {{ javascript_include('js/angular/contactlist/dist/contactlist.8576d5b33165d5da9c34.min.js') }}
