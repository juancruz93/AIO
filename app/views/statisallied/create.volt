<div class="subtitleIndex">
    Aquí puede crear un plan de acción.
</div>
    ...
    <div class="col-lg-6 col-sm-12 panel-left">
        <section class="panel">
            <header class="panel-heading panel-title">
                Agregue un nuevo plan de acción
            </header>
                    ...
                    <form novalidate class="form-validate form-horizontal" id="feedback_form" method="get" ng-submit="validateActionPlan()">
                        <div class="form-group" id="idActionPlan">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                <input ng-model="actionplan.name" type="text" required="required" class="form-control" minlength="2" maxlength="45">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                <textarea ng-model="actionplan.description" rows="2" type="text" required="required" class="form-control" minlength="2" maxlength="200"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cname" class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-3">Proyecto <span class="required">*</span></label>
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                <span class="input hoshi input-default">
                                    <ui-select ng-model="actionplan.idProject" ng-required="true"
                                               ui-select-required  sortable="false"
                                               close-on-select="true">
                                        <ui-select-match
                                            placeholder="Seleccione uno">{{ "{{$select.selected.name}}" }}</ui-select-match>
                                        <ui-select-choices
                                            repeat="key.idProject as key in project.items | propsFilter: {name: $select.search}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                <span class="input hoshi input-default">
                                    <ui-select ng-model="actionplan.impact" ng-required="true"
                                               ui-select-required  sortable="false"
                                               close-on-select="true">
                                        <ui-select-match
                                            placeholder="Seleccione uno">{{ "{{$select.selected.name}}" }}</ui-select-match>
                ...
                <div>
                    <div class="module-item row">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-4 text-right">                            
                            <i class="fastAdd icon_plus_alt " ng-click="addActivity()"></i>
                        </div>
                    </div>
                    ...
                    <div id="" class="requirements-items">
                        ...
                        <div class="requirement-item  row requirement-save" id="requirementCrud" ng-repeat="activity in activities">
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                                <div class="row" >
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 small-text">
                                        <textarea  id="descriptionValidate" ng-model="activity.description" type="text" required="required"
                                                   class="form-control" minlength="2" maxlength="300" rows="1"></textarea>
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 small-text">
                                        <input ng-model="activity.responsable" type="text" required="required" class="form-control" minlength="2"
                                               maxlength="45"/>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 small-text">
                                        ...
                                        <!--<input type='date' ng-model="activity.datestart" class="form-control" id='' />--> 
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 small-text">
                                        <datepicker date-format="dd-MM-yyyy">
                                            <input type="text" ng-model="activity.dateend" class="form-control" onkeydown="return false" placeholder="Elige una fecha"/>
                                        </datepicker>
                                        <!--<input type='date' ng-model="activity.dateend" class="form-control" id='' />      -->              
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 small-text">
                                        <input type="number" ng-model="activity.porcentage" class="form-control" minlength="0" maxlength="3"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 text-right" style="font-size: 20px;">               

                                <i class="fastCancel icon_close_alt"  ng-if="porcentageid" ng-click="clearActivity($index)"></i>
                            </div>
                        </div>
                        <div class="requirement-item">
                            <div class=" each-requirement" ng-if="listactivities.items.length > 0" ng-repeat="requirement in listactivities.items">
                                <div class="row request-item" id="request-item-{{"{{requirement.idActivity}}"}}">
                                    ...
                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 text-right">
                                        <i class="fastCancel icon_close_alt" data-toggle="modal" data-target="#deleteRequirementModal" ng-click="setDeleteRequirement(requirement.idRequest)"></i>                    {# <i class="fastEdit icon_pencil_alt " ng-click="showEditRequirement(requirement)"></i>#}
                                    </div>
                                </div>
                                <div class="row editrequest-item displaynone" id="editrequest-item-{{"{{requirement.idActivity}}"}}">
                                    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 small-text">
                                                <md-input-container>
                                                    <input flex type="text" ng-model="editactivity.porcentage" aria-label="blue" aria-controls="blue-slider" min="0" max="100">
                                                </md-input-container>  
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 text-right">
                                        <i class="fastCancel icon_close_alt" ng-model="editactivity.cancel"></i>
                                    </div>
                                </div>
