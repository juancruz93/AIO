...
//					$this->children[] = '<a href="$$$_social_media_share_$$$' . \str_replace(" ", "", $lowersocialname) . '"><img src="' .'/images/editor/socials/share/theme_' . $data->theme . '/share_' . \str_replace(" ", "_", $lowersocialname) . '_image_' . $data->size .'.png" style="margin-right: 8px;"></a>';
					$this->children[] = '<a href="$$$_social_media_share_$$$' . \str_replace(" ", "", $lowersocialname) . '"><img src="' . $domain->name . '/images/editor/socials/share/theme_' . $data->theme . '/share_' . \str_replace(" ", "_", $lowersocialname) . '_image_' . $data->size .'.png" style="margin-right: 8px;"></a>';
